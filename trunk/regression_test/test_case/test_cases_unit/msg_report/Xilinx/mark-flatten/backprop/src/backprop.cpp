...
#pragma ACCEL kernel
void backprop_kernel(TYPE weights1[input_dimension*nodes_per_layer], 
                TYPE weights2[nodes_per_layer*nodes_per_layer],
                TYPE weights3[nodes_per_layer*possible_outputs],
                TYPE biases1[nodes_per_layer], 
                TYPE biases2[nodes_per_layer],
    ...
    #ifndef MC_BASELINE
    #pragma ACCEL interface variable=weights1 depth=832
    #pragma ACCEL interface variable=weights2 depth=4096
    #pragma ACCEL interface variable=weights3 depth=192
    #pragma ACCEL interface variable=biases1 depth=64
    #pragma ACCEL interface variable=biases2 depth=64
    #pragma ACCEL interface variable=biases3 depth=3
    #pragma ACCEL interface variable=training_data depth=2119
    #pragma ACCEL interface variable=training_targets depth=489
    #endif
