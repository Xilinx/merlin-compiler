...
void recv_data(volatile float *global_data,unsigned int offset,float data[32][784 + 64])
{
  memcpy(( *data),((void *)(global_data + offset)),((64 + 784) * 32 * 4));
}

void compute1(float data[32][784 + 64],float weights[64][784 + 1],float result1[32][64])
{
  int i;
  int j;
  int k;
...
void compute2(float result1[32][64],float data[32][784 + 64],float result2[32][64])
{
  int j;
  int k;
  STAGE2_L:
...
void compute3(float result2[32][64],float data[32][784 + 64],float gradient[64][784 + 1])
{
  int i;
  int j;
  int k;
...
void mars_kernel_1_4_0_node_1_stage_0(int i,int exec,float data[32][784 + 64],volatile float *global_data)
{
...
void mars_kernel_1_4_0_node_2_stage_1(int i,int exec,float data[32][784 + 64],float result1[32][64],float weights[64][784 + 1])
{
...
void mars_kernel_1_4_0_node_3_stage_2(int i,int exec,float data[32][784 + 64],float result1[32][64],float result2[32][64])
{
...
void mars_kernel_1_4_0_node_4_stage_3(int i,int exec,float data[32][784 + 64],float gradient[64][784 + 1],float result2[32][64])
{
...
void mars_kernel_1_4_0_assign_data(float target[32][784 + 64],float orig[32][784 + 64])
{
  int i1;
  int i0;
  for (i0 = 0; i0 < 32; i0++) {
...
void mars_kernel_1_4_0_assign_gradient(float target[64][784 + 1],float orig[64][784 + 1])
{
  int i1;
  int i0;
  for (i0 = 0; i0 < 64; i0++) {
...
void mars_kernel_1_4_0_assign_weights(float target[64][784 + 1],float orig[64][784 + 1])
{
  int i1;
  int i0;
  for (i0 = 0; i0 < 64; i0++) {
...
void mars_kernel_1_4_0(int mars_i,int mars_init,int mars_cond,float mars_data_0[32][784 + 64],float mars_data_1[32][784 + 64],float mars_data_2[32][784 + 64],float mars_data_3[32][784 + 64],volatile float *mars_global_data_0,float mars_gradient_3[64][784 + 1],float mars_result1_1[32][64],float mars_result1_2[32][64],float mars_result2_2[32][64],float mars_result2_3[32][64],float mars_weights_1[64][784 + 1])
{
  mars_kernel_1_4_0_node_0_stage_0(mars_i - 0,mars_i >= mars_init + 0 & mars_i < mars_cond + 0);
  mars_kernel_1_4_0_node_1_stage_0(mars_i - 0,mars_i >= mars_init + 0 & mars_i < mars_cond + 0,mars_data_0,mars_global_data_0);
  mars_kernel_1_4_0_node_2_stage_1(mars_i - 1,mars_i >= mars_init + 1 & mars_i < mars_cond + 1,mars_data_1,mars_result1_1,mars_weights_1);
  mars_kernel_1_4_0_node_3_stage_2(mars_i - 2,mars_i >= mars_init + 2 & mars_i < mars_cond + 2,mars_data_2,mars_result1_2,mars_result2_2);
  mars_kernel_1_4_0_node_4_stage_3(mars_i - 3,mars_i >= mars_init + 3 & mars_i < mars_cond + 3,mars_data_3,mars_gradient_3,mars_result2_3);
}

void pipeline(int n_samples,volatile float *global_data,float weights[64][784 + 1],float gradient[64][784 + 1])
{
  int i;
...
#pragma HLS loop_tripcount max=1875
    ...
    static float mars_kernel_1_4_0_data_3[32][784 + 64];
    static float mars_kernel_1_4_0_data_2[32][784 + 64];
    static float mars_kernel_1_4_0_data_1[32][784 + 64];
    static float mars_kernel_1_4_0_data_0[32][784 + 64];
...
#ifdef ADD_IF
#endif
  float weights[64][784 + 1];
  float gradient[64][784 + 1];
  int i;
  int j;
  int k;
  float regs[64];
