...
//assert(num_samples <= 64);
  num_samples <= 1024?((void )0) : __assert_fail("num_samples <= 1024","host.cpp",34,__PRETTY_FUNCTION__);
...
// compute test results
  ...
  gradient(num_samples,10,784,((class ap_uint< 512 > *)weights),data_samples,((class ap_uint< 512 > *)output_test),((class ap_uint< 512 > *)feature_samples),((class ap_uint< 512 > *)label_samples));
// compare results
