...
void mars_kernel_0_14_1_node_0_stage_0(int start,int j0,int exec)
{
...
void mars_kernel_0_14_1_node_1_stage_0(int start,int j0,int exec,class ap_uint< 512 > *indices,int indices_3_0_buf[500][36])
{
  
#pragma HLS INLINE OFF
  if (exec == 1) {
    
#pragma HLS array_partition variable=indices_3_0_buf cyclic factor = 16 dim=2
//HEAVY_LOOP:  
    ::memcpy_wide_bus_read_int_2d(indices_3_0_buf, 0, 0, ((class ap_uint< 512 > *)indices),((unsigned int )(((unsigned long )(0 + (start * 180000 + j0 * 18000))) * sizeof(int ))),((unsigned int )(sizeof(int ) * ((unsigned long )18000))));
  }
}

void mars_kernel_0_14_1_node_2_stage_1(int start,int j0,int exec,Scalar accu[9][1000],double data1_3_0_buf[90000],double data_3_0_buf[90000],int indices_3_0_buf[500][36],int step)
{
...
//8cycles
        ...
        if (i == 0) {
//8cycles
          accu[0][sub_start1] = x1 * x1;
          accu[1][sub_start1] = x1 * y1;
          accu[2][sub_start1] = x1 * z1;
          accu[3][sub_start1] = y1 * y1;
          accu[4][sub_start1] = y1 * z1;
          accu[5][sub_start1] = z1 * z1;
          accu[6][sub_start1] = x1;
          accu[7][sub_start1] = y1;
          accu[8][sub_start1] = z1;
        }
         else {
//8cycles
          accu[0][sub_start1] += x1 * x1;
...
void mars_kernel_0_14_1_node_3_stage_2(int start,int j0,int exec,Scalar accu[9][1000],int n,double normal_t_4_0_buf[10][3000],double origin_t_4_0_buf[10][3000],Scalar ptr1,Scalar ptr2,Scalar ptr3)
{
...
//#pragma ACCEL parallel complete
        accu_local[i] = accu[i][sub_start] / ((double )18);
      }
...
void mars_kernel_0_14_1_assign_n(int target,int orig)
{
  target = orig;
}

void mars_kernel_0_14_1_assign_normal_t_4_0_buf(double target[10][3000],double orig[10][3000])
{
  int i1;
  int i0;
  for (i0 = 0; i0 < 10; i0++) {
...
void mars_kernel_0_14_1_assign_origin_t_4_0_buf(double target[10][3000],double orig[10][3000])
{
  int i1;
  int i0;
  for (i0 = 0; i0 < 10; i0++) {
...
void mars_kernel_0_14_1_assign_ptr1(Scalar target,Scalar orig)
{
  target = orig;
}

void mars_kernel_0_14_1_assign_ptr2(Scalar target,Scalar orig)
{
  target = orig;
}

void mars_kernel_0_14_1_assign_ptr3(Scalar target,Scalar orig)
{
  target = orig;
}

void mars_kernel_0_14_1(int mars_start,int mars_j0,int mars_init,int mars_cond,Scalar mars_accu_1[9][1000],Scalar mars_accu_2[9][1000],double mars_data1_3_0_buf_1[90000],double mars_data_3_0_buf_1[90000],class ap_uint< 512 > *indices,int mars_indices_3_0_buf_0[500][36],int mars_indices_3_0_buf_1[500][36],int mars_n_2,double mars_normal_t_4_0_buf_2[10][3000],double mars_origin_t_4_0_buf_2[10][3000],Scalar mars_ptr1_2,Scalar mars_ptr2_2,Scalar mars_ptr3_2,int mars_step_1)
{
  mars_kernel_0_14_1_node_0_stage_0(mars_start,mars_j0 - 0,mars_j0 >= mars_init + 0 & mars_j0 < mars_cond + 0);
  mars_kernel_0_14_1_node_1_stage_0(mars_start,mars_j0 - 0,mars_j0 >= mars_init + 0 & mars_j0 < mars_cond + 0,indices,mars_indices_3_0_buf_0);
  mars_kernel_0_14_1_node_2_stage_1(mars_start,mars_j0 - 1,mars_j0 >= mars_init + 1 & mars_j0 < mars_cond + 1,mars_accu_1,mars_data1_3_0_buf_1,mars_data_3_0_buf_1,mars_indices_3_0_buf_1,mars_step_1);
  mars_kernel_0_14_1_node_3_stage_2(mars_start,mars_j0 - 2,mars_j0 >= mars_init + 2 & mars_j0 < mars_cond + 2,mars_accu_2,mars_n_2,mars_normal_t_4_0_buf_2,mars_origin_t_4_0_buf_2,mars_ptr1_2,mars_ptr2_2,mars_ptr3_2);
}
...
#pragma HLS array_partition variable=origin_t_4_0_buf cyclic factor = 8 dim=2
    ...
    int mars_count_0_14_1 = 0;
    for (j0 = 0; j0 < 10 + 2; j0++) 
// Original: #pragma ACCEL pipeline
// Original: #pragma ACCEL PIPELINE II=1
{
      static int indices_3_0_buf[500][36];
      Scalar accu[9][1000];
      Scalar accu1[9][1000];
//HEAVY_LOOP:  
//SLOW_LOOP:            
      static int mars_kernel_0_14_1_indices_3_0_buf_2[500][36];
      static int mars_kernel_0_14_1_indices_3_0_buf_1[500][36];
      static int mars_kernel_0_14_1_indices_3_0_buf_0[500][36];
      static Scalar mars_kernel_0_14_1_accu_2[9][1000];
      static Scalar mars_kernel_0_14_1_accu_1[9][1000];
      static Scalar mars_kernel_0_14_1_accu_0[9][1000];
      if (mars_count_0_14_1 == 0) 
        mars_kernel_0_14_1(start,j0,0,10,mars_kernel_0_14_1_accu_0,mars_kernel_0_14_1_accu_1,data1_3_0_buf,data_3_0_buf,indices,mars_kernel_0_14_1_indices_3_0_buf_0,mars_kernel_0_14_1_indices_3_0_buf_1,n,normal_t_4_0_buf,origin_t_4_0_buf,ptr1,ptr2,ptr3,step);
       else if (mars_count_0_14_1 == 1) 
        mars_kernel_0_14_1(start,j0,0,10,mars_kernel_0_14_1_accu_2,mars_kernel_0_14_1_accu_0,data1_3_0_buf,data_3_0_buf,indices,mars_kernel_0_14_1_indices_3_0_buf_2,mars_kernel_0_14_1_indices_3_0_buf_0,n,normal_t_4_0_buf,origin_t_4_0_buf,ptr1,ptr2,ptr3,step);
       else 
        mars_kernel_0_14_1(start,j0,0,10,mars_kernel_0_14_1_accu_1,mars_kernel_0_14_1_accu_2,data1_3_0_buf,data_3_0_buf,indices,mars_kernel_0_14_1_indices_3_0_buf_1,mars_kernel_0_14_1_indices_3_0_buf_2,n,normal_t_4_0_buf,origin_t_4_0_buf,ptr1,ptr2,ptr3,step);
      mars_count_0_14_1++;
      if (mars_count_0_14_1 == 3) 
        mars_count_0_14_1 = 0;
    }
    
#pragma HLS array_partition variable=normal_t_4_0_buf cyclic factor = 8 dim=2
    ::memcpy_wide_bus_write_double_2d(((class ap_uint< 512 > *)normal_t),normal_t_4_0_buf, 0, 0, (sizeof(double ) * (0 + start * 30000)),(sizeof(double ) * ((unsigned long )30000)));
  }
