...
void func_top_17() {
  ...
  for (i = 0; i < 100; i++)
    for (j = 0; j < 100; j++) {
      a[i][j] =
          b[10587946 * i][j] + b[10587946 * i + 1][j] + b[10587946 * i - 1][j];
    }
}
...
void func_top_18() {
  ...
  for (i = 0; i < 100; i++)
    for (j = 0; j < 100; j++) {
      a[i][j] =
          b[10587946 * i][j] + b[35935221 * i + 1][j] + b[43453045 * i - 1][j];
    }
}

#pragma ACCEL kernel
void func_top_19(int b[10000]) {
  int a[100][100];
  int i, j;
  for (j = 0; j < 100; j++)
    for (i = 0; i < 100; i++) {
...
#define n 5
#pragma ACCEL kernel
void func_top_45(int A_out[_PB_N], int k) {
  int A[_PB_N][_PB_N][_PB_N][_PB_N][_PB_N];
...
void func_top_48(int *a, int sum) {
  int i, j, k;
  for (j = N_size; j < N_size + 100; j++) {
    for (k = N_size; k < N_size + 100; k++) {
      sum += a[100 * j + k];
      sum += a[100 * j + 100 + k];
      sum += a[100 * j + k + 1];
    }
...
#pragma ACCEL kernel
void func_top_52(int *sum, int b[100]) {
  int a[100][100];
