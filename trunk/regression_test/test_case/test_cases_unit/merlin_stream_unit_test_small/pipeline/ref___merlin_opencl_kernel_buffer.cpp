...
opencl_kernel __prefetch_c_kernel;
cl_event __event_prefetch_c;
opencl_kernel __prefetch_b_kernel;
cl_event __event_prefetch_b;
opencl_kernel __prefetch_a_kernel;
cl_event __event_prefetch_a;
int __merlin_init_vec_add_kernel(){
	...
	#pragma ACCEL debug fflush(stdout);
	opencl_create_buffer(&__vec_add_kernel__a_buffer, (int64_t)4*1048576, 2, NULL);
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "a");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create buffer for %s....\n", "b");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_buffer(&__vec_add_kernel__b_buffer, (int64_t)4*1048576, 2, NULL);
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "b");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create buffer for %s....\n", "c");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_buffer(&__vec_add_kernel__c_buffer, (int64_t)4*1048576, 2, NULL);
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "c");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create kernel for %s....\n", "prefetch_c");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_kernel(&__prefetch_c_kernel, (char *)"prefetch_c");
	#pragma ACCEL debug printf("[Merlin Info] Successful create kernel for %s....\n", "prefetch_c");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create kernel for %s....\n", "prefetch_b");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_kernel(&__prefetch_b_kernel, (char *)"prefetch_b");
	#pragma ACCEL debug printf("[Merlin Info] Successful create kernel for %s....\n", "prefetch_b");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create kernel for %s....\n", "prefetch_a");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_kernel(&__prefetch_a_kernel, (char *)"prefetch_a");
	#pragma ACCEL debug printf("[Merlin Info] Successful create kernel for %s....\n", "prefetch_a");
	#pragma ACCEL debug fflush(stdout);
	return 0;
}
...
int __merlin_wait_kernel_vec_add_kernel(){
	...
	opencl_wait_event(__event_prefetch_c);
	opencl_wait_event(__event_prefetch_b);
	opencl_wait_event(__event_prefetch_a);
	return 0;
}
