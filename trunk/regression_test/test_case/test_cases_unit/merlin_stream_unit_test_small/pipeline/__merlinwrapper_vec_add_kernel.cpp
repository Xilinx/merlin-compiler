...
void __merlinwrapper_vec_add_kernel(int a[1024 * 1024],int b[1024 * 1024],int c[1024 * 1024],int inc)
{
{
...
#pragma ACCEL debug fflush(stdout);
      if (a != 0) {
        memcpy((void *)(__m_a + 0),(const void *)a,1048576 * sizeof(int ));
      }
       else {
...
#pragma ACCEL debug fflush(stdout);
      if (b != 0) {
        memcpy((void *)(__m_b + 0),(const void *)b,1048576 * sizeof(int ));
      }
       else {
...
#pragma ACCEL debug fflush(stdout);
      if (c != 0) {
        memcpy((void *)(__m_c + 0),(const void *)c,1048576 * sizeof(int ));
      }
       else {
...
#pragma ACCEL debug fflush(stdout);
      if (a != 0) {
        memcpy((void *)a,(const void *)(__m_a + 0),1048576 * sizeof(int ));
      }
       else {
        printf("Error! Detected null pointer 'a' for external memory.\n");
        exit(1);
...
#pragma ACCEL debug fflush(stdout);
      if (b != 0) {
        memcpy((void *)b,(const void *)(__m_b + 0),1048576 * sizeof(int ));
      }
       else {
        printf("Error! Detected null pointer 'b' for external memory.\n");
        exit(1);
...
#pragma ACCEL debug fflush(stdout);
      if (c != 0) {
        memcpy((void *)c,(const void *)(__m_c + 0),1048576 * sizeof(int ));
      }
       else {
        printf("Error! Detected null pointer 'c' for external memory.\n");
        exit(1);
...
void __merlin_vec_add_kernel(int a[1024 * 1024],int b[1024 * 1024],int c[1024 * 1024],int inc)
{
...
void __merlin_write_buffer_vec_add_kernel(int a[1024 * 1024],int b[1024 * 1024],int c[1024 * 1024],int inc)
{
  static int __m_a[1048576];
  static int __m_b[1048576];
  static int __m_c[1048576];
...
void __merlin_read_buffer_vec_add_kernel(int a[1024 * 1024],int b[1024 * 1024],int c[1024 * 1024],int inc)
{
  static int __m_a[1048576];
  static int __m_b[1048576];
  static int __m_c[1048576];
...
void __merlin_execute_vec_add_kernel(int a[1024 * 1024],int b[1024 * 1024],int c[1024 * 1024],int inc)
{
}
