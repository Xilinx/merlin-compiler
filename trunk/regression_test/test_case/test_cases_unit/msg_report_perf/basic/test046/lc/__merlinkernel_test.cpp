...
static void merlin_memcpy_1(int dst[128],int dst_idx_0,int *src,int src_idx_0,unsigned long len,unsigned long max_len)
{
...
#pragma ACCEL interface variable=c max_depth=128 depth=128
  int b_buf_1[128];
  memcpy(b_buf_1,b,128*4);
  func1((char *)a_buf_0,b_buf_1,(long *)c_buf_0);
