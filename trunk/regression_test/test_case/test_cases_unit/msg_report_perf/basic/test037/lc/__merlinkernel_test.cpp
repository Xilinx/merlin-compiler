...
__kernel void test(char *a,int *b,merlin_uint_512 *c,int m)
{
...
// Existing HLS partition: #pragma HLS array_partition variable=c_buf_0 cyclic factor = 8 dim=1
  memcpy_wide_bus_read_long_512(&c_buf_0[0],(merlin_uint_512 *)c,(0 * 8),sizeof(long ) * ((unsigned long )128),128LL);
