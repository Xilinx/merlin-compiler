...
#define TOTAL_MEM_SIZE 600000 //(3*352*288)
	...
	int * row2col_data; cmost_malloc_1d(&row2col_data, "", 4, TOTAL_MEM_SIZE);
	int * dequant_data; cmost_malloc_1d(&dequant_data, "+", 4, TOTAL_MEM_SIZE);
	int * text_data;    cmost_malloc_1d(&text_data,    "0", 4, TOTAL_MEM_SIZE);
