...
#pragma ACCEL interface variable=A depth=479,647
  
#pragma ACCEL interface variable=B depth=331,647
  
#pragma ACCEL interface variable=C depth=479,331
              ...
              for (int i_row_pe = 0; i_row_pe < 11; ++i_row_pe) 
                for (int j_col_pe = 0; j_col_pe < 14; ++j_col_pe) 
                  for (int k_simd_pe = 0; k_simd_pe < 8; ++k_simd_pe) {
                    ...
                    int i_sys = i_outer * 242 + (i_row_pe * 22 + i_feeder);
