...
{
#pragma ACCEL interface variable=in depth=39,81,2
#pragma ACCEL interface variable=weight depth=25,3,3,2
#pragma ACCEL interface variable=out depth=37,79,25
