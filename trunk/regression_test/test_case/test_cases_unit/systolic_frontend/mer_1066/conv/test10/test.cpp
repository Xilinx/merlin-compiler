...
{
#pragma ACCEL interface variable=in depth=112,112,128
#pragma ACCEL interface variable=weight depth=896,1,1,128
#pragma ACCEL interface variable=out depth=112,112,896
