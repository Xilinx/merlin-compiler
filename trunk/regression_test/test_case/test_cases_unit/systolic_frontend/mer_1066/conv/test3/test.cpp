...
{
#pragma ACCEL interface variable=in depth=1026,1026,35
#pragma ACCEL interface variable=weight depth=35,3,3,35
#pragma ACCEL interface variable=out depth=1024,1024,35
