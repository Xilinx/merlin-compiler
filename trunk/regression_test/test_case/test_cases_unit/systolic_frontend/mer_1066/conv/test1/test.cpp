...
{
#pragma ACCEL interface variable=in depth=15,15,168
#pragma ACCEL interface variable=weight depth=192,3,3,168
#pragma ACCEL interface variable=out depth=13,13,192
