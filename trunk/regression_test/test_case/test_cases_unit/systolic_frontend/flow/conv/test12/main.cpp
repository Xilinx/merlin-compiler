...
int main(int argc, char **argv)
{
	...
	float *b;
	float *c;
	unsigned int num_elem_a = (IMG_ROW + K - 1) * (IMG_COL + K - 1) * IMG_IN_NUM;
	unsigned int num_elem_b = IMG_OUT_NUM * K * K * IMG_IN_NUM;
	unsigned int num_elem_c = IMG_ROW * IMG_COL * IMG_OUT_NUM;
