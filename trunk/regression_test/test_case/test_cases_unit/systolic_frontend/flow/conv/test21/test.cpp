...
{
#pragma ACCEL interface variable=in depth=59,9,45
#pragma ACCEL interface variable=weight depth=123,3,3,45
#pragma ACCEL interface variable=out depth=57,7,123
