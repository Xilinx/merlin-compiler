...
int main(int argc, char **argv)
{
	...
	float *b;
	float *c;
//	unsigned int num_elem_a = (2 * 6 * 10) * (2 * 8 * 8);
//	unsigned int num_elem_b = (1 * 4 * 16) * (2 * 8 * 8);
//	unsigned int num_elem_c = (2 * 6 * 10) * (1 * 4 * 16);
	unsigned int num_elem_a = 4 * 64;
	unsigned int num_elem_b = 128 * 64;
	unsigned int num_elem_c = 4 * 128;
