...
int main(int argc, char **argv)
{
	...
	float *b;
	float *c;
	unsigned int num_elem_a = 64 * 160;
	unsigned int num_elem_b = 80 * 160;
	unsigned int num_elem_c = 64 * 80;
//	unsigned int num_elem_a = 64 * 128;
//	unsigned int num_elem_b = 64 * 128;
//	unsigned int num_elem_c = 64 * 64;
