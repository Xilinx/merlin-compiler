...
#pragma ACCEL PARALLEL COMPLETE
    int _in_s_i_0 = (int )(((long )4) + 4L * ((long )_s_i_0));
...
#pragma ACCEL PARALLEL COMPLETE
    int _in_s_i = (int )(((long )20) + 4L * ((long )_s_i));
...
#pragma ACCEL interface variable=data bus_bitwidth=128 max_depth=268435456 depth=268435456
...
//#pragma ACCEL parallel flatten factor=2
}
