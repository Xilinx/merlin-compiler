...
static unsigned long long  merlin_get_range_64(merlin_uint_64 *tmp, int low, int len) {
...
static void merlin_set_range_64(merlin_uint_64 *tmp, int low, int len, unsigned long long val) {
#pragma HLS INLINE SELF 
  int i;
  int start = low;
  switch (len) {
