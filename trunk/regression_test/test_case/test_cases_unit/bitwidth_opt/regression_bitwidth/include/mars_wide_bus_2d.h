...
#define memcpy_wide_bus(access, type, size, bus) instant_size(access, type, size, bus)
#define instant_size(access, type, size, bus) memcpy_wide_bus_##access##_##type##_2d_##size##_##bus

static void
memcpy_wide_bus(read, char, SIZE_1, LARGE_BUS) (char a_buf[][SIZE_1], size_t index2_offset, 
...
static void
memcpy_wide_bus(write, char, SIZE_1, LARGE_BUS) (MARS_WIDE_BUS_TYPE *c, char c_buf[][SIZE_1],
...
static void
memcpy_wide_bus(read, short, SIZE_1, LARGE_BUS) (short a_buf[][SIZE_1], size_t index2_offset, 
                             size_t index1_offset, MARS_WIDE_BUS_TYPE *a,
                            size_t offset_byte, size_t size_byte, const size_t const_buf_size) {
#pragma HLS inline self
...
static void
memcpy_wide_bus(write, short, SIZE_1, LARGE_BUS) (MARS_WIDE_BUS_TYPE *c, short c_buf[][SIZE_1],
                             size_t index2_offset, size_t index1_offset,
                             size_t offset_byte, size_t size_byte, const size_t const_buf_size) {
#pragma HLS inline self
  const size_t data_width = sizeof(short);
...
static void
memcpy_wide_bus(read, long, SIZE_1, LARGE_BUS)(long a_buf[][SIZE_1], size_t index2_offset, size_t index1_offset,
...
static void
memcpy_wide_bus(write, long, SIZE_1, LARGE_BUS) (MARS_WIDE_BUS_TYPE *c, long c_buf[][SIZE_1],
                             size_t index2_offset, size_t index1_offset,
                             size_t offset_byte, size_t size_byte, const size_t const_buf_size) {
#pragma HLS inline self
  const size_t data_width = sizeof(long);
...
static void
memcpy_wide_bus(read, int, SIZE_1, LARGE_BUS)(int a_buf[][SIZE_1], size_t index2_offset, size_t index1_offset,
                             MARS_WIDE_BUS_TYPE *a,
...
static void
memcpy_wide_bus(write, long_long, SIZE_1, LARGE_BUS) (MARS_WIDE_BUS_TYPE *c, long long c_buf[][SIZE_1],
                             size_t index2_offset, size_t index1_offset,
                             size_t offset_byte, size_t size_byte, const size_t const_buf_size) {
#pragma HLS inline self
...
static void
memcpy_wide_bus(read, long_long, SIZE_1, LARGE_BUS)(long long a_buf[][SIZE_1], size_t index2_offset, size_t index1_offset,
                             MARS_WIDE_BUS_TYPE *a,
...
static void
memcpy_wide_bus(write, int, SIZE_1, LARGE_BUS) (MARS_WIDE_BUS_TYPE *c, int c_buf[][SIZE_1],
                             size_t index2_offset, size_t index1_offset,
                             size_t offset_byte, size_t size_byte, const size_t const_buf_size) {
#pragma HLS inline self
  const size_t data_width = sizeof(int);
...
static void memcpy_wide_bus(read, float, SIZE_1, LARGE_BUS) (float a_buf[][SIZE_1],
...
static void memcpy_wide_bus(write, float, SIZE_1, LARGE_BUS)(MARS_WIDE_BUS_TYPE *c,
                                                  float c_buf[][SIZE_1],
                                                  size_t index2_offset,
                                                  size_t index1_offset,
                                                  size_t offset_byte,
...
static void memcpy_wide_bus(read, double, SIZE_1, LARGE_BUS)(double a_buf[][SIZE_1],
                                                  size_t index2_offset,
                                                  size_t index1_offset,
                                                  MARS_WIDE_BUS_TYPE *a,
                                                  size_t offset_byte,
...
static void memcpy_wide_bus(write, double, SIZE_1, LARGE_BUS)(MARS_WIDE_BUS_TYPE *c,
                                                   double c_buf[][SIZE_1],
                                                   size_t index2_offset,
                                                   size_t index1_offset,
                                                   size_t offset_byte,
