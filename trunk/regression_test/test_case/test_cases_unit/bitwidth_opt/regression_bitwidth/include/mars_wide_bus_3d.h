...
#define memcpy_wide_bus(access, type, size1, size2, bus) instant_size(access, type, size1, size2, bus)
#define instant_size(access, type, size1, size2, bus) memcpy_wide_bus_##access##_##type##_3d_##size1##_##size2##_##bus


static void
memcpy_wide_bus(read, char, SIZE_1, SIZE_2, LARGE_BUS)(char a_buf[][SIZE_1][SIZE_2], 
...
static void
memcpy_wide_bus(write, char, SIZE_1, SIZE_2, LARGE_BUS)(MARS_WIDE_BUS_TYPE *c, char c_buf[][SIZE_1][SIZE_2],
                             size_t index3_offset, size_t index2_offset, 
...
static void
memcpy_wide_bus(read, short, SIZE_1, SIZE_2, LARGE_BUS)(short a_buf[][SIZE_1][SIZE_2], 
                            size_t index3_offset, size_t index2_offset,
                            size_t index1_offset, MARS_WIDE_BUS_TYPE *a,
                            size_t offset_byte, size_t size_byte, const size_t const_buf_size) {
#pragma HLS inline self
...
static void
memcpy_wide_bus(write, short, SIZE_1, SIZE_2, LARGE_BUS)(MARS_WIDE_BUS_TYPE *c, short c_buf[][SIZE_1][SIZE_2],
                             size_t index3_offset, size_t index2_offset, 
                             size_t index1_offset,
                             size_t offset_byte, size_t size_byte, const size_t const_buf_size) {
#pragma HLS inline self
...
static void
memcpy_wide_bus(read, int, SIZE_1, SIZE_2, LARGE_BUS)(int a_buf[][SIZE_1][SIZE_2], 
...
static void
memcpy_wide_bus(write, int, SIZE_1, SIZE_2, LARGE_BUS)(MARS_WIDE_BUS_TYPE *c, int c_buf[][SIZE_1][SIZE_2],
                                                   size_t index3_offset,
                                                   size_t index2_offset,
                                                   size_t index1_offset,
                             size_t offset_byte, size_t size_byte, const size_t const_buf_size) {
...
static void
memcpy_wide_bus(read, long, SIZE_1, SIZE_2, LARGE_BUS)(long a_buf[][SIZE_1][SIZE_2], 
                                                   size_t index3_offset,
                                                   size_t index2_offset,
                                                   size_t index1_offset,
                            MARS_WIDE_BUS_TYPE *a,
...
static void
memcpy_wide_bus(write, long, SIZE_1, SIZE_2, LARGE_BUS)(MARS_WIDE_BUS_TYPE *c, long c_buf[][SIZE_1][SIZE_2],
                                                   size_t index3_offset,
                                                   size_t index2_offset,
                                                   size_t index1_offset,
                             size_t offset_byte, size_t size_byte, const size_t const_buf_size) {
...
static void
memcpy_wide_bus(read, long_long, SIZE_1, SIZE_2, LARGE_BUS)(long long a_buf[][SIZE_1][SIZE_2], 
                                                   size_t index3_offset,
                                                   size_t index2_offset,
                                                   size_t index1_offset,
                            MARS_WIDE_BUS_TYPE *a,
...
static void
memcpy_wide_bus(write, long_long, SIZE_1, SIZE_2, LARGE_BUS)(MARS_WIDE_BUS_TYPE *c, long long c_buf[][SIZE_1][SIZE_2],
                                                   size_t index3_offset,
                                                   size_t index2_offset,
                                                   size_t index1_offset,
                             size_t offset_byte, size_t size_byte, const size_t const_buf_size) {
    ...
    if (head_align == 0 && aligned) {
      if (aligned == 1) {
        ...
        for (j0 = 0; j0 < num_elements / SIZE_2; ++j0) {
          for (j1 = 0; j1 < SIZE_2; ++j1) {
            j = j0 * SIZE_2 + j1;
            long long val = c_buf[index3][index2 * num_elements / SIZE_2 + j0][j1];
            tmp3(c[i + start], data_width, (j * data_width), val);
          }
        }
        ++index2;
...
static void memcpy_wide_bus(read, float, SIZE_1, SIZE_2, LARGE_BUS)(float a_buf[][SIZE_1][SIZE_2],
                                                   size_t index3_offset,
                                                   size_t index2_offset,
                                                   size_t index1_offset,
                                                 MARS_WIDE_BUS_TYPE *a,
...
static void memcpy_wide_bus(write, float, SIZE_1, SIZE_2, LARGE_BUS)(MARS_WIDE_BUS_TYPE *c,
...
static void
memcpy_wide_bus(read, double, SIZE_1, SIZE_2, LARGE_BUS)(double a_buf[][SIZE_1][SIZE_2],
                                                   size_t index3_offset,
                                                   size_t index2_offset,
                                                   size_t index1_offset,
