...
void pe_1(unsigned int k,float q_i,float q_j,float r_ij_x,float r_ij_y,float r_ij_z,float r2,float sub_force_x[4],float sub_force_y[4],float sub_force_z[4])
//float *force_x_temp,
//float *force_y_temp,
//float *force_z_temp
{
...
//					if within cutoff(pe_0)
            ...
            if (pe_0(pos_x_i,pos_y_i,pos_z_i,pos_x_j,pos_y_j,pos_z_j,&r_ij_x,&r_ij_y,&r_ij_z,&r2) == 1) {
              pe_1(k,q_i,q_j,r_ij_x,r_ij_y,r_ij_z,r2,sub_force_x,sub_force_y,sub_force_z);
            }
          }
// end if
        }
