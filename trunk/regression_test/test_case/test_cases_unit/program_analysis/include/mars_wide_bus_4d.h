...
#define memcpy_wide_bus(access, type, size1, size2, size3) instant_size(access, type, size1, size2, size3)
#define instant_size(access, type, size1, size2, size3) memcpy_wide_bus_##access##_##type##_4d_##size1##_##size2##_##size3


static void
memcpy_wide_bus(read, char, SIZE_1, SIZE_2, SIZE_3)(char a_buf[][SIZE_1][SIZE_2][SIZE_3], 
...
static void
memcpy_wide_bus(write, char, SIZE_1, SIZE_2, SIZE_3)(MARS_WIDE_BUS_TYPE *c, 
...
static void
memcpy_wide_bus(read, int, SIZE_1, SIZE_2, SIZE_3)(int a_buf[][SIZE_1][SIZE_2][SIZE_3], 
                                                   size_t index4_offset,
                                                   size_t index3_offset,
                                                   size_t index2_offset,
                                                   size_t index1_offset,
...
static void
memcpy_wide_bus(write, int, SIZE_1, SIZE_2, SIZE_3)(MARS_WIDE_BUS_TYPE *c, 
...
static void memcpy_wide_bus(read, float, SIZE_1, SIZE_2, SIZE_3)(
...
static void memcpy_wide_bus(write, float, SIZE_1, SIZE_2, SIZE_3)(MARS_WIDE_BUS_TYPE *c,
...
static void
memcpy_wide_bus(read, double, SIZE_1, SIZE_2, SIZE_3)(double a_buf[][SIZE_1][SIZE_2][SIZE_3],
                                                   size_t index4_offset,
                                                   size_t index3_offset,
                                                   size_t index2_offset,
                                                   size_t index1_offset,
    ...
    if (head_align == 0 && aligned) {
      if (aligned == 1) {
        for (j = 0; j < num_elements; ++j) {
          if (i == end - start - 1 && j > tail_align)
            continue;
            long long raw_bits = tmp2(((j + 1) * data_width * 8 - 1), (j * data_width * 8));
...
static void memcpy_wide_bus(write, double, SIZE_1, SIZE_2, SIZE_3)(
