...
{
#pragma ACCEL interface variable=a1 depth=10,10 type=m_axi
#pragma ACCEL interface variable=a3 depth=,10 type=m_axi
#pragma ACCEL interface variable=a4 depth=10  type=m_axi
