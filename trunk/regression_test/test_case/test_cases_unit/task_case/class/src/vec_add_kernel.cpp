...
void vec_add_kernel1(counter_cls * a, int *b, int*c, int inc);
void vec_add_kernel2(counter_cls * d, int *b, int*c, int inc);

#pragma ACCEL task parallel
void vec_add_top(counter_cls *a, int *b, counter_cls *d, int*c1, int *c2, int inc)
{
