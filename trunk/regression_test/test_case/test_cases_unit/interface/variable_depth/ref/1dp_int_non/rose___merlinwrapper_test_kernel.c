...
#pragma ACCEL wrapper variable=a port=a depth=1000 max_depth=1000 data_type=int io=RW copy=true
  }
  static int __m_a[1000];
{
    if (a != 0) {
      memcpy(((void *)(__m_a + 0)),((const void *)a),1000 * sizeof(int ));
    }
     else {
...
{
    if (a != 0) {
      memcpy(((void *)a),((const void *)(__m_a + 0)),1000 * sizeof(int ));
    }
     else {
      printf("Error! The external memory pointed by 'a' is invalid.\n");
      exit(1);
