...
extern void vec_add_kernel(int a[VEC_SIZE], int b[VEC_SIZE], int c[VEC_SIZE], int * d[2], int inc);
...
{   
    ...
    int ** d = (int **)malloc(sizeof(int)*VEC_SIZE/2);
    ...
    vec_add_kernel(a, b, c_acc, d, inc);
