...
//#define LAG1 (uint16_t(24))
//#define LAG2 (uint16_t(55))
//#define RAND_SSIZE ((uint16_t(1))<<6)
#define LAG1 24
#define LAG2 55
#define RAND_SSIZE 64
...
static inline void prng_srand(uint64_t seed, struct prng_rand_t *state) {
  ...
  const uint64_t temp_i = 2147483647;
  state->s[0] = seed;
