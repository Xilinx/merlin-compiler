...
static unsigned long long  merlin_get_range_512(merlin_uint_512 *tmp, int low, int len) {
...
static void merlin_set_range_512(merlin_uint_512 *tmp, int low, int len, unsigned long long val) {
#pragma HLS INLINE SELF 
  int i;
  int start = low;
  switch (len) {
