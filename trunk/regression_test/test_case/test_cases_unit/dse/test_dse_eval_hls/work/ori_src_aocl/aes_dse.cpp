...
void aes256_encrypt_ecb(unsigned char k[32],unsigned char buf[16])
...
#pragma ACCEL interface variable=key depth=32
  
#pragma ACCEL interface variable=data bus_bitwidth=auto{options: B=[8,512]; default:8} depth=268435456
...
#pragma ACCEL parallel factor=auto{options: CGPAR2=[x for x in [1,2,3,4,5,6,7,8,16]]; order: 0 if v & (v-1) == 0 else 1; default:1}
