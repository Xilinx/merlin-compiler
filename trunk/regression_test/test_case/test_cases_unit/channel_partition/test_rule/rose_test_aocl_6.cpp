...
void merlin_assign_m128i_0(unsigned char (*lhs_data)[16],int i_sub)
{
  int i_0;
...
#pragma ACCEL PARALLEL COMPLETE
    merlin_stream_read(&ch_profbuf_vec_data_3_p[i_sub][i_0],(&profbuf_vec_data_sn_tmp_0));
...
#pragma ACCEL PARALLEL COMPLETE
          ...
          merlin_stream_write(&ch_profbuf_vec_data_3_p[_i_sub_4][_i_0_5],(&profbuf_vec_data_sp_tmp_0));
        }
      }
    }
  }
...
#pragma ACCEL parallel
    int i_0;
    for (i_0 = 0; i_0 <= 15UL; ++i_0) {
      
#pragma ACCEL parallel
      merlin_stream_init(&ch_profbuf_vec_data_3_p[i_sub_0][i_0],(unsigned long )0,(unsigned long )1);
    }
  }
...
#pragma ACCEL PARALLEL
      ...
      for (int _j_l24 = 0; _j_l24 < 128; _j_l24++) {
        merlin_assign_m128i_0(&profbuf_data[_j_l24],i_sub);
      }
    }
  }
  int i_sub_1;
...
#pragma ACCEL parallel
    int i_0_0;
    for (i_0_0 = 0; i_0_0 <= 15UL; ++i_0_0) {
      
#pragma ACCEL parallel
      merlin_stream_reset(&ch_profbuf_vec_data_3_p[i_sub_1][i_0_0]);
    }
  }
}
