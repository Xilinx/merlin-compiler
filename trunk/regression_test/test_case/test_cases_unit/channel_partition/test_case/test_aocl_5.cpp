...
merlin_stream ch_a_buf_0_2[5][10];
...
#pragma ACCEL parallel
        k = k0 * 10 + kk;
        merlin_stream_read(&ch_a_buf_0_2[jj][kk],&a_buf_0_sn_tmp);
...
#pragma ACCEL parallel
        ...
        merlin_stream_write(&ch_a_buf_0_2[jj][_kk],&a_buf_0_sp_tmp);
      }
    }
  }
}
...
#pragma ACCEL parallel
      ...
      for (kk = 0; kk <= 9; ++kk) {
#pragma ACCEL parallel
        merlin_stream_init(&ch_a_buf_0_2[jj][kk],((unsigned long )10000),((unsigned long )4));
      }
...
#pragma ACCEL parallel
        merlin_stream_reset(&ch_a_buf_0_2[jj][kk_0]);
      }
