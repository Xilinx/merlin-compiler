...
void merlin_stream_init(merlin_stream *var, 
...
void merlin_stream_read(merlin_stream *var, void *data_out) {
  ...
  switch (var->data_size) {
    case 1:  *(char*) data_out = *(((char*)var->buffer) + var->curr_read_pos);
             break;
    case 2:  *(short*) data_out = *(((short*)var->buffer) + var->curr_read_pos);
             break;
    case 4:  *(int*) data_out = *(((int*)var->buffer) + var->curr_read_pos);
             break;
    case 8:  *(long long*) data_out = *(((long long*)var->buffer) + var->curr_read_pos);
             break;
    default:
...
void merlin_stream_write(merlin_stream *var, void *data_in) {
  ...
  switch (var->data_size) {
    case 1:  *(((char*)var->buffer) + var->curr_write_pos) = *(char*) data_in;
             break;
    case 2:  *(((short*)var->buffer) + var->curr_write_pos) = *(short*) data_in;
             break;
    case 4:  *(((int *)var->buffer) + var->curr_write_pos) = *(int*) data_in;
             break;
    case 8:  *(((long long*)var->buffer) + var->curr_write_pos) = *(long long*) data_in;
             break;
    default:
             assert(0 && "cannot support data type");
             break;
