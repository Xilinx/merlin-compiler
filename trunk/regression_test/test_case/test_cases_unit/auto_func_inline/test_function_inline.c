...
int * sub2_3z_wrap(int * sub2_3z_wrap_a) { return sub2_3z_wrap_a; }
...
#pragma hls array_partition variable=test2_3z_a dim=1
  sub2_3z(sub2_3z_wrap(test2_3z_a)); // Note that sub2_3x is not inlined currently
...
void sub3_3ss(int * sub3_3ss_a) { sub3_3sss(sub3_3ss_a);  }
void sub3_3s(int * sub3_3s_a) { sub3_3ss(sub3_3s_a); }

void sub3_3tt(int * sub3_3tt_a) {  }
void sub3_3ts(int * sub3_3ts_a) { sub3_3tt(sub3_3ts_a); }
void sub3_3t(int * sub3_3t_a) { sub3_3ts(sub3_3t_a);  sub3_3tt(sub3_3t_a); }

void sub3_3ut(int * sub3_3ut_a) {
#pragma HLS array_partition variable=sub3_3ut_a dim=1
}
void sub3_3us(int * sub3_3us_a) { sub3_3ut(sub3_3us_a); }
void sub3_3u(int * sub3_3u_a) { sub3_3us(sub3_3u_a);  sub3_3ut(sub3_3u_a); }
...
void sub3_3ws(int * sub3_3ws_a) { sub3_3wt(0,sub3_3ws_a); }
void sub3_3w(int * sub3_3w_a) { sub3_3ws(0);  sub3_3wt(sub3_3w_a,0); }

void sub3_3xs(int * sub3_3xs_a) { }
void sub3_3xt(int ** sub3_3xt_a) {
#pragma HLS array_partition variable=sub3_3xt_a dim=2
}
void sub3_3x(int ** sub3_3x_a) { sub3_3xs(sub3_3x_a[0]);  sub3_3xt(sub3_3x_a); }

void sub3_3ys(int * sub3_3ys_a) { }
void sub3_3yt(int ** sub3_3yt_a) {
#pragma HLS array_partition variable=sub3_3yt_a dim=1
}
void sub3_3y(int ** sub3_3y_a) { sub3_3ys(sub3_3y_a[0]);  sub3_3yt(sub3_3y_a); }
...
{
  int test4_1_a[16];
  int * test4_1_pa = test4_1_a; // this is ignored currently
#pragma HLS array_partition variable=test4_1_a dim=1
  sub4_1(test4_1_pa); 

  int * test4_1s_pa = test4_1_pa; // this is ignored currently
  sub4_1s(test4_1s_pa); 

  int * test4_1t_pa = test4_1s_pa; // this is ignored currently
  sub4_1t(test4_1t_pa); 
}
...
#pragma ACCEL kernel
void test6_5(){} // moved to test_function_inline.cpp
