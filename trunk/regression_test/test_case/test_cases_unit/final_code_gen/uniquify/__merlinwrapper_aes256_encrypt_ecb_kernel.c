...
#pragma ACCEL debug fflush(stdout);
      if (ctx != 0 && ctx[_i0] . key != 0) {
        memcpy(((void *)(__m_ctx_key + _i0 * 32)),((const void *)ctx[_i0] . key),32 * sizeof(unsigned char ));
      }
       else {
...
#pragma ACCEL debug fflush(stdout);
      if (ctx != 0 && ctx[_i0] . enckey != 0) {
        memcpy(((void *)(__m_ctx_enckey + _i0 * 32)),((const void *)ctx[_i0] . enckey),32 * sizeof(unsigned char ));
      }
       else {
...
#pragma ACCEL debug fflush(stdout);
      if (ctx != 0 && ctx[_i0] . deckey != 0) {
        memcpy(((void *)(__m_ctx_deckey + _i0 * 32)),((const void *)ctx[_i0] . deckey),32 * sizeof(unsigned char ));
      }
       else {
...
#pragma ACCEL debug fflush(stdout);
      if (k != 0) {
        memcpy(((void *)(__m_k + 0)),((const void *)k),32 * sizeof(unsigned char ));
      }
       else {
...
#pragma ACCEL debug fflush(stdout);
      if (buf != 0) {
        memcpy(((void *)(__m_buf + 0)),((const void *)buf),16 * sizeof(unsigned char ));
      }
       else {
...
#pragma ACCEL kernel
  aes256_encrypt_ecb_kernel(__m_ctx_key,__m_ctx_enckey,__m_ctx_deckey,__m_k,__m_buf);
{
    int _i0;
/*
    static unsigned char __m_ctx_key[32];
...
#pragma ACCEL debug fflush(stdout);
      if (ctx != 0 && ctx[_i0] . key != 0) {
        memcpy(((void *)ctx[_i0] . key),((const void *)(__m_ctx_key + _i0 * 32)),32 * sizeof(unsigned char ));
      }
       else {
        printf("Error! The external memory pointed by 'ctx[_i0] . key' is invalid.\n");
        exit(1);
...
#pragma ACCEL debug fflush(stdout);
      if (ctx != 0 && ctx[_i0] . enckey != 0) {
        memcpy(((void *)ctx[_i0] . enckey),((const void *)(__m_ctx_enckey + _i0 * 32)),32 * sizeof(unsigned char ));
      }
       else {
        printf("Error! The external memory pointed by 'ctx[_i0] . enckey' is invalid.\n");
        exit(1);
...
#pragma ACCEL debug fflush(stdout);
      if (ctx != 0 && ctx[_i0] . deckey != 0) {
        memcpy(((void *)ctx[_i0] . deckey),((const void *)(__m_ctx_deckey + _i0 * 32)),32 * sizeof(unsigned char ));
      }
       else {
        printf("Error! The external memory pointed by 'ctx[_i0] . deckey' is invalid.\n");
        exit(1);
...
#pragma ACCEL debug fflush(stdout);
      if (buf != 0) {
        memcpy(((void *)buf),((const void *)(__m_buf + 0)),16 * sizeof(unsigned char ));
      }
       else {
        printf("Error! The external memory pointed by 'buf' is invalid.\n");
        exit(1);
