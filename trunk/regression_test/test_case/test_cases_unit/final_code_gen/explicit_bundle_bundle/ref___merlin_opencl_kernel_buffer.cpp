...
int __merlin_init_vec_add_kernel(){
	...
	#pragma ACCEL debug printf("[Merlin Info] Start create buffer for %s....\n", "d");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_buffer(&__vec_add_kernel__d_buffer, (int64_t)4, 2, NULL);
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "d");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create buffer for %s....\n", "e");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_buffer(&__vec_add_kernel__e_buffer, (int64_t)8, 2, NULL);
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "e");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create buffer for %s....\n", "f");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_buffer(&__vec_add_kernel__f_buffer, (int64_t)4, 2, NULL);
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "f");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create buffer for %s....\n", "g");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_buffer(&__vec_add_kernel__g_buffer, (int64_t)8, 2, NULL);
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "g");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create buffer for %s....\n", "h");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_buffer(&__vec_add_kernel__h_buffer, (int64_t)4, 2, NULL);
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "h");
	#pragma ACCEL debug fflush(stdout);
	return 0;
}
