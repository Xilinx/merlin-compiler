...
#pragma ACCEL kernel die=lower
{
	...
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 4, sizeof(opencl_mem), &__vec_add_kernel__d_buffer);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 5, sizeof(opencl_mem), &__vec_add_kernel__e_buffer);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 6, sizeof(opencl_mem), &__vec_add_kernel__f_buffer);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 7, sizeof(opencl_mem), &__vec_add_kernel__g_buffer);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 8, sizeof(opencl_mem), &__vec_add_kernel__h_buffer);
