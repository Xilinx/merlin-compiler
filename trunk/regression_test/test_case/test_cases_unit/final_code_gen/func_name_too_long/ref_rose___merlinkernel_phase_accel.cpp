...
static void p_ZN2xf11accel_utils13Array2hlsStrmILi256ELi2160ELi3840ELi1ELi1ELi16ELi518400EEEP7ap_uintILi256EER6s(struct xf_accel_utils *this_,class ap_uint< 256 > *srcPtr,class hls::stream< ap_uint< 256 >  > &dstStrm,int rows,int cols)
{
...
static void p_ZN2xf11accel_utils13Array2hlsStrmILi256ELi2160ELi3840ELi1ELi1ELi16ELi518400EEEP7ap_uintILi256EER6s0(struct xf_accel_utils *this_,class ap_uint< 256 > *srcPtr,class hls::stream< ap_uint< 256 >  > &dstStrm,int rows,int cols)
{
  int pixel_width = 1 * 16;
  int loop_count = (rows * cols * 16 + 256 - 1) / 256;
  merlinL1:
...
static void p_ZN2xf11accel_utils13hlsStrm2xfMatILi256ELi2ELi2160ELi3840ELi1ELi8294400EEER6streamI7ap_uintILi256E(struct xf_accel_utils *this_,class hls::stream< ap_uint< 256 >  > &srcStrm,class xf::Mat< 2 , 2160 , 3840 , 1 > &dstMat)
{
...
static void p_ZN2xf11accel_utils11Array2xfMatILi256ELi2ELi2160ELi3840ELi1EEEP7ap_uintILi256EER3MatILi2ELi2160ELi(struct xf_accel_utils *this_,class ap_uint< 256 > *srcPtr,class xf::Mat< 2 , 2160 , 3840 , 1 > &dstMat)
{
...
#pragma HLS DATAFLOW
  ...
  class hls::stream< ap_uint< 256 >  > strm;
  int rows = dstMat . rows;
  int cols = dstMat . cols;
  p_ZN2xf11accel_utils13Array2hlsStrmILi256ELi2160ELi3840ELi1ELi1ELi16ELi518400EEEP7ap_uintILi256EER6s(this_,srcPtr,strm,rows,cols);
  p_ZN2xf11accel_utils13Array2hlsStrmILi256ELi2160ELi3840ELi1ELi1ELi16ELi518400EEEP7ap_uintILi256EER6s0(this_,srcPtr,strm,rows,cols);
  p_ZN2xf11accel_utils13hlsStrm2xfMatILi256ELi2ELi2160ELi3840ELi1ELi8294400EEER6streamI7ap_uintILi256E(this_,strm,dstMat);
}

static void p_ZN2xf11Array2xfMatILi256ELi2ELi2160ELi3840ELi1EEEP7ap_uintILi256EER3MatILi2ELi2160ELi3840ELi1EE(class ap_uint< 256 > *srcPtr,class xf::Mat< 2 , 2160 , 3840 , 1 > &dstMat)
{
  struct xf_accel_utils au;
  p_ZN2xf11accel_utils11Array2xfMatILi256ELi2ELi2160ELi3840ELi1EEEP7ap_uintILi256EER3MatILi2ELi2160ELi(&au,srcPtr,dstMat);
}
...
static void p_ZN2xf13xfPhaseKernelILi2ELi2ELi2160ELi3840ELi3ELi3ELi1ELi5ELi5ELi3840EEER3MatILi2ELi2160ELi3840ELi(class xf::Mat< 2 , 2160 , 3840 , 1 > &_src1,class xf::Mat< 2 , 2160 , 3840 , 1 > &_src2,class xf::Mat< 2 , 2160 , 3840 , 1 > &_dst_mat,int _out_format,unsigned short &imgheight,unsigned short &imgwidth)
{
        ...
        }
{
        ...
        val_dst . range(((int )(k+(16 - 1))),((int )k)) = ((unsigned long )result);
      }
...
static void p_ZN2xf5phaseILi1ELi2ELi2ELi2160ELi3840ELi1EEER3MatILi2ELi2160ELi3840ELi1EER3MatILi2ELi2160ELi3840EL(class xf::Mat< 2 , 2160 , 3840 , 1 > &_src_matx,class xf::Mat< 2 , 2160 , 3840 , 1 > &_src_maty,class xf::Mat< 2 , 2160 , 3840 , 1 > &_dst_mat)
{
  ...
  p_ZN2xf13xfPhaseKernelILi2ELi2ELi2160ELi3840ELi3ELi3ELi1ELi5ELi5ELi3840EEER3MatILi2ELi2160ELi3840ELi(_src_matx,_src_maty,_dst_mat,1,imgheight,imgwidth);
}

static void p_ZN2xf11accel_utils13xfMat2hlsStrmILi256ELi2ELi2160ELi3840ELi1ELi8294400EEER3MatILi2ELi2160ELi3840E(struct xf_accel_utils *this_,class xf::Mat< 2 , 2160 , 3840 , 1 > &srcMat,class hls::stream< ap_uint< 256 >  > &dstStrm)
{
...
static void p_ZN2xf11accel_utils13hlsStrm2ArrayILi256ELi2160ELi3840ELi1ELi1ELi16ELi518400EEER6streamI7ap_uintILi(struct xf_accel_utils *this_,class hls::stream< ap_uint< 256 >  > &srcStrm,class ap_uint< 256 > *dstPtr,int rows,int cols)
{
  int pixel_width = 1 * 16;
  int loop_count = (rows * cols * 16 + 256 - 1) / 256;
  merlinL6:
...
static void p_ZN2xf11accel_utils11xfMat2ArrayILi256ELi2ELi2160ELi3840ELi1EEER3MatILi2ELi2160ELi3840ELi1EEP7ap_ui(struct xf_accel_utils *this_,class xf::Mat< 2 , 2160 , 3840 , 1 > &srcMat,class ap_uint< 256 > *dstPtr)
{
...
#pragma HLS DATAFLOW
  ...
  int rows = srcMat . rows;
  int cols = srcMat . cols;
  p_ZN2xf11accel_utils13xfMat2hlsStrmILi256ELi2ELi2160ELi3840ELi1ELi8294400EEER3MatILi2ELi2160ELi3840E(this_,srcMat,strm);
  p_ZN2xf11accel_utils13hlsStrm2ArrayILi256ELi2160ELi3840ELi1ELi1ELi16ELi518400EEER6streamI7ap_uintILi(this_,strm,dstPtr,rows,cols);
}

static void p_ZN2xf11xfMat2ArrayILi256ELi2ELi2160ELi3840ELi1EEER3MatILi2ELi2160ELi3840ELi1EEP7ap_uintILi256EE(class xf::Mat< 2 , 2160 , 3840 , 1 > &srcMat,class ap_uint< 256 > *dstPtr)
{
  struct xf_accel_utils au;
  p_ZN2xf11accel_utils11xfMat2ArrayILi256ELi2ELi2160ELi3840ELi1EEER3MatILi2ELi2160ELi3840ELi1EEP7ap_ui(&au,srcMat,dstPtr);
}
static int phase_accelxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx_dummy_pos;
#pragma ACCEL kernel
extern "C" { 

__kernel void phase_accelxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx(class ap_uint< 256 > *img_inp1,class ap_uint< 256 > *img_inp2,class ap_uint< 256 > *img_out,int rows,int cols)
{
...
#pragma HLS DATAFLOW
  ...
  p_ZN2xf5phaseILi1ELi2ELi2ELi2160ELi3840ELi1EEER3MatILi2ELi2160ELi3840ELi1EER3MatILi2ELi2160ELi3840EL(_src1,_src2,_dst);
