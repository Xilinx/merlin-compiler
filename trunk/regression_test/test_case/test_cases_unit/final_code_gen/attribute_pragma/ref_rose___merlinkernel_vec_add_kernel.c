...
{
/* #pragma ACCEL attribute register variable=x */
  int __attribute__((register)) x[5];
/* #pragma ACCEL attribute register variable=y */
  int __attribute__((register)) y[2][2] = {{(1), (2)}, {(3), (4)}};
/* #pragma ACCEL attribute register variable=m */
  const int __attribute__((register)) m[5];
/* #pragma ACCEL attribute register variable=n */
  const int __attribute__((register)) n[2][2] = {{(1), (2)}, {(3), (4)}};
/* #pragma ACCEL attribute register variable=p */
  static int __attribute__((register)) p[5];
/* #pragma ACCEL attribute register variable=q */
  static int __attribute__((register)) q[2][2] = {{(1), (2)}, {(3), (4)}};
/* #pragma ACCEL attribute singlepump bankwidth=512 variable=b_buf_0 */
  int __attribute__((singlepump,bankwidth(512))) b_buf_0[10000];
  long _memcpy_i_1;
...
/* #pragma ACCEL attribute singlepump bank_bits=2,1 variable=c_buf_0 */
  int __attribute__((singlepump,bank_bits(2,1))) c_buf_0[10000];
