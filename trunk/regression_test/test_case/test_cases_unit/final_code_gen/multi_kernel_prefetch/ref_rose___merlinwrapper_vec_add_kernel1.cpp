...
}
{
	...
	#pragma ACCEL debug fflush(stdout);
	opencl_set_kernel_arg(__msm_port_a_vec_add_kernel1_0_kernel, 0, sizeof(opencl_mem), &__vec_add_kernel1__a_buffer);
	#pragma ACCEL debug printf("[Merlin Info] Finish set kernel %s argument....\n", "msm_port_a_vec_add_kernel1_0");
	#pragma ACCEL debug fflush(stdout);
}
{
	...
	#pragma ACCEL debug fflush(stdout);
	opencl_set_kernel_arg(__msm_port_b_vec_add_kernel1_0_kernel, 0, sizeof(opencl_mem), &__vec_add_kernel1__b_buffer);
	#pragma ACCEL debug printf("[Merlin Info] Finish set kernel %s argument....\n", "msm_port_b_vec_add_kernel1_0");
	#pragma ACCEL debug fflush(stdout);
}
{
	...
	#pragma ACCEL debug fflush(stdout);
	opencl_set_kernel_arg(__msm_port_c_vec_add_kernel1_0_kernel, 0, sizeof(opencl_mem), &__vec_add_kernel1__c_buffer);
	#pragma ACCEL debug printf("[Merlin Info] Finish set kernel %s argument....\n", "msm_port_c_vec_add_kernel1_0");
	#pragma ACCEL debug fflush(stdout);
}
{
	...
	size_t __gid[1];
	__gid[0] = 1;
	opencl_enqueue_kernel(__vec_add_kernel1_kernel, commands[4], 1, __gid, &__event_vec_add_kernel1);
}
{
	#pragma ACCEL debug printf("[Merlin Info] Start execute kernel %s....\n", "msm_port_a_vec_add_kernel1_0");
	#pragma ACCEL debug fflush(stdout);
	size_t __gid[1];
	__gid[0] = 1;
	opencl_enqueue_kernel(__msm_port_a_vec_add_kernel1_0_kernel, commands[5], 1, __gid, &__event_msm_port_a_vec_add_kernel1_0);
}
{
	#pragma ACCEL debug printf("[Merlin Info] Start execute kernel %s....\n", "msm_port_b_vec_add_kernel1_0");
	#pragma ACCEL debug fflush(stdout);
	size_t __gid[1];
	__gid[0] = 1;
	opencl_enqueue_kernel(__msm_port_b_vec_add_kernel1_0_kernel, commands[6], 1, __gid, &__event_msm_port_b_vec_add_kernel1_0);
}
{
	#pragma ACCEL debug printf("[Merlin Info] Start execute kernel %s....\n", "msm_port_c_vec_add_kernel1_0");
	#pragma ACCEL debug fflush(stdout);
	size_t __gid[1];
	__gid[0] = 1;
	opencl_enqueue_kernel(__msm_port_c_vec_add_kernel1_0_kernel, commands[7], 1, __gid, &__event_msm_port_c_vec_add_kernel1_0);
}
{
...
{
	clWaitForEvents(1, &__event_msm_port_a_vec_add_kernel1_0);
	if(__event_msm_port_a_vec_add_kernel1_0) {
		opencl_release_event(__event_msm_port_a_vec_add_kernel1_0);
	}
	#pragma ACCEL debug printf("[Merlin Info] Finish execute kernel %s....\n", "msm_port_a_vec_add_kernel1_0");
	#pragma ACCEL debug fflush(stdout);
}
{
	clWaitForEvents(1, &__event_msm_port_b_vec_add_kernel1_0);
	if(__event_msm_port_b_vec_add_kernel1_0) {
		opencl_release_event(__event_msm_port_b_vec_add_kernel1_0);
	}
	#pragma ACCEL debug printf("[Merlin Info] Finish execute kernel %s....\n", "msm_port_b_vec_add_kernel1_0");
	#pragma ACCEL debug fflush(stdout);
}
{
	clWaitForEvents(1, &__event_msm_port_c_vec_add_kernel1_0);
	if(__event_msm_port_c_vec_add_kernel1_0) {
		opencl_release_event(__event_msm_port_c_vec_add_kernel1_0);
	}
	#pragma ACCEL debug printf("[Merlin Info] Finish execute kernel %s....\n", "msm_port_c_vec_add_kernel1_0");
	#pragma ACCEL debug fflush(stdout);
}
