...
#pragma ACCEL debug fflush(stdout);
      if (d != 0) {
        memcpy((void *)(__m_d + 0),(const void *)d,10000 * sizeof(int ));
      }
       else {
...
#pragma ACCEL sub_kernel parent=vec_add_kernel2
  msm_port_d_vec_add_kernel2_0(__m_d);
  
#pragma ACCEL sub_kernel parent=vec_add_kernel2
  msm_port_b_vec_add_kernel2_0(__m_b);
  
#pragma ACCEL kernel die=SLR1
  vec_add_kernel2(__m_d,__m_b,__m_c,inc);
  
#pragma ACCEL sub_kernel parent=vec_add_kernel2
  msm_port_c_vec_add_kernel2_0(__m_c);
{
