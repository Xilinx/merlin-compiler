...
void __merlinwrapper_vec_add_kernel(int a[200000],int b[200000],int c[200000],int inc)
{
{
    
#pragma ACCEL wrapper variable=a port=a depth=200000 max_depth=200000 data_type=int io=RO copy=false
    
#pragma ACCEL wrapper variable=b port=b depth=200000 max_depth=200000 data_type=int io=RO copy=false
    
#pragma ACCEL wrapper variable=c port=c depth=200000 max_depth=200000 data_type=int io=WO copy=false
...
void __merlin_vec_add_kernel(int a[200000],int b[200000],int c[200000],int inc)
{
...
void __merlin_write_buffer_vec_add_kernel(int a[200000],int b[200000],int c[200000],int inc)
{
  static int __m_a[200000];
  static int __m_b[200000];
  static int __m_c[200000];
...
void __merlin_read_buffer_vec_add_kernel(int a[200000],int b[200000],int c[200000],int inc)
{
  static int __m_a[200000];
  static int __m_b[200000];
  static int __m_c[200000];
...
void __merlin_execute_vec_add_kernel(int a[200000],int b[200000],int c[200000],int inc)
{
}
