...
opencl_mem_ext ext___vec_add_kernel__a_buffer;
...
int __merlin_init_vec_add_kernel(){
	...
	#pragma ACCEL debug fflush(stdout);
	ext___vec_add_kernel__a_buffer.flags = XCL_MEM_DDR_BANK0;
	ext___vec_add_kernel__a_buffer.obj   = NULL;
	ext___vec_add_kernel__a_buffer.param = 0;
	opencl_create_ext_buffer(&__vec_add_kernel__a_buffer,&ext___vec_add_kernel__a_buffer, (long)4*10000, 2);
	// --xp misc:map_connect=add.kernel.vec_add_kernel_1.M_AXI_A.core.OCL_REGION_0.M00_AXI
	// --sp vec_add_kernel_1.m_axi_bank0:bank0
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "A");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create buffer for %s....\n", "b");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_buffer(&__vec_add_kernel__b_buffer, (long)4*10000, 2);
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "b");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create buffer for %s....\n", "c");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_buffer(&__vec_add_kernel__c_buffer, (long)4*10000, 2);
	#pragma ACCEL debug printf("[Merlin Info] Successful create buffer for %s....\n", "c");
	#pragma ACCEL debug fflush(stdout);
	return 0;
}
