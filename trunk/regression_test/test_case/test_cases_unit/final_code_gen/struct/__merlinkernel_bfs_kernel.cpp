...
{
  __merlin_access_range(level_counts,0,9UL);
  __merlin_access_range(level,0,255UL);
  __merlin_access_range(edges_dst,0,4095UL);
  __merlin_access_range(nodes_edge_end,0,255UL);
  __merlin_access_range(nodes_edge_begin,0,255UL);
  unsigned long n;
  unsigned long e;
  unsigned long cnt;
...
#pragma unroll 64
  ...
  __merlin_access_range(level_counts,0,9999UL);
  __merlin_access_range(level,0,255999UL);
  __merlin_access_range(starting_node,0,0UL);
  __merlin_access_range(edges_dst,0,4095999UL);
  __merlin_access_range(nodes_edge_end,0,255999UL);
  __merlin_access_range(nodes_edge_begin,0,255999UL);
