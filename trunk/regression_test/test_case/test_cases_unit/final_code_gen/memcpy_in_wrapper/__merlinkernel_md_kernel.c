...
#pragma unroll 8
  ...
  __merlin_access_range(position_z,0,639UL);
  __merlin_access_range(position_y,0,639UL);
  __merlin_access_range(position_x,0,639UL);
  __merlin_access_range(force_z,0,639UL);
  __merlin_access_range(force_y,0,639UL);
  __merlin_access_range(force_x,0,639UL);
  __merlin_access_range(n_points,0,63UL);
