...
void vec_add_kernel(int *a,int *b,int *c,int inc,int i,int i_0);
static void __merlin_dummy_extern_int_merlin_include_L_();
#include "__merlinhead_kernel_top.h"
static void __merlin_dummy_extern_int_merlin_include_L_();

void __merlinwrapper_vec_add_kernel(int *a,int *b,int *c,int inc,int i,int i_0)
{
...
#pragma ACCEL kernel
{
	...
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 4, sizeof(int), &i);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 5, sizeof(int), &i_0);
...
void __merlin_vec_add_kernel(int *a,int *b,int *c,int inc,int i,int i_0)
{
  
#pragma ACCEL string __merlin_check_opencl();
  
#pragma ACCEL string __merlin_init_vec_add_kernel();
  __merlinwrapper_vec_add_kernel(a,b,c,inc,1,2);
  
#pragma ACCEL string __merlin_release_vec_add_kernel();
}

void __merlin_write_buffer_vec_add_kernel(int *a,int *b,int *c,int inc,int i,int i_0)
{
  static int __m_a[10000];
  static int __m_b[10000];
  static int __m_c[10000];
...
void __merlin_read_buffer_vec_add_kernel(int *a,int *b,int *c,int inc,int i,int i_0)
{
  static int __m_a[10000];
  static int __m_b[10000];
  static int __m_c[10000];
...
void __merlin_execute_vec_add_kernel(int *a,int *b,int *c,int inc,int i,int i_0)
{
  int i_1;
{
	#pragma ACCEL debug printf("[Merlin Info] Start set kernel %s argument....\n", "vec_add_kernel");
