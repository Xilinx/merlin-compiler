...
__global int * sub(__global volatile int *a)
{
  return a + 1;
}
...
{
  __global volatile int *ret_ptr = sub((__global int * )a);
  __global volatile int *ret_ptr_2 = sub((__global int * )a) + 2;
  int *ret_ptr_3 = &sub((__global int * )a)[0] - 1;
  __global volatile int *ret_ptr_4 = sub((__global int * )a) - 1;
...
#pragma ACCEL interface variable=c max_depth=10000 depth=10000
  ...
  adder((__global int * )d,(__global int * )a,inc);
  adder_3(1,2,3);
  long _memcpy_i_2;
