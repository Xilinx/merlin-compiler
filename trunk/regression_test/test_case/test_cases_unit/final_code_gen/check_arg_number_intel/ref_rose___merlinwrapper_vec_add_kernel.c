...
#pragma ACCEL kernel
{
	...
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 4, sizeof(int), &a1);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 5, sizeof(int), &a2);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 6, sizeof(int), &a3);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 7, sizeof(int), &a4);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 8, sizeof(int), &a5);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 9, sizeof(int), &a6);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 10, sizeof(int), &a7);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 11, sizeof(int), &a8);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 12, sizeof(int), &a9);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 13, sizeof(int), &a10);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 14, sizeof(int), &a11);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 15, sizeof(int), &a12);
	opencl_set_kernel_arg(__vec_add_kernel_kernel, 16, sizeof(int), &a13);
