...
__kernel void vec_add_kernel(__global int * restrict a,__global int * restrict b,__global int * restrict c,int inc,int a1,int a2,int a3,int a4,int a5,int a6,int a7,int a8,int a9,int a10,int a11,int a12,int a13)
{
  int b_buf_0[10000];
  long _memcpy_i_1;
...
#pragma ACCEL interface variable=a max_depth=10000 depth=10000 bank=0
