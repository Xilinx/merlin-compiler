...
void vec_add_kernel1(int m, int n) {
}
void vec_add_kernel1(int m) {
}
void vec_add_kernel1() {
}
void vec_add_kernel2(int m, int n) {
}
void vec_add_kernel2(int m) {
}
void vec_add_kernel2() {
}
void vec_add_kernel1_merlin_clone0(int *a,int *b,int *c,int inc)
{
