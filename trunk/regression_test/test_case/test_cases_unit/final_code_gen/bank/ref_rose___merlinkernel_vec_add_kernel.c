...
#pragma HLS INTERFACE m_axi port=a offset=slave bundle=merlin_gmem_vec_add_kernel_bank0 depth=10000
  
#pragma HLS INTERFACE m_axi port=b offset=slave depth=10000 bundle=merlin_gmem_vec_add_kernel_32_0
