...
extern int __merlinwrapper_vec_add_kernel(int *a, int *b);
extern int __merlin_write_buffer_vec_add_kernel(int *a, int *b);
extern int __merlin_read_buffer_vec_add_kernel(int *a, int *b);
extern int __merlin_execute_vec_add_kernel(int *a, int *b);
extern int __merlin_vec_add_kernel(int *a, int *b);
