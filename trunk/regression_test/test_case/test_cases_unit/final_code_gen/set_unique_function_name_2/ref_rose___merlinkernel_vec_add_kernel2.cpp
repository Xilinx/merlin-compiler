...
static int vec_add_kernel2_dummy_pos;
extern "C" { 

__kernel void vec_add_kernel2(::merlin_uint_512 *d,::merlin_uint_512 *b,::merlin_uint_512 *c,int inc)
{
  
#pragma HLS INTERFACE m_axi port=b offset=slave depth=625 bundle=merlin_gmem_vec_add_kernel2_512_0
  
#pragma HLS INTERFACE m_axi port=c offset=slave depth=625 bundle=merlin_gmem_vec_add_kernel2_512_0
  
#pragma HLS INTERFACE m_axi port=d offset=slave depth=625 bundle=merlin_gmem_vec_add_kernel2_512_1
