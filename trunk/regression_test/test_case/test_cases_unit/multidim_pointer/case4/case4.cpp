...
#pragma ACCEL kernel
__kernel void vec_add_kernel(int a[10240], int c[20480], int inc)
{

#pragma HLS INTERFACE m_axi port=a offset=slave depth=10240
#pragma HLS INTERFACE m_axi port=c offset=slave depth=20480
...
#pragma ACCEL interface variable=c max_depth=20480 depth=20480
  int *B[10];
