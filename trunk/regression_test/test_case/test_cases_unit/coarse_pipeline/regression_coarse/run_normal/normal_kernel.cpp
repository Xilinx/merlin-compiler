...
#pragma HLS array_partition variable=indices_3_0_buf cyclic factor = 16 dim=2
      ::memcpy_wide_bus_read_int_2d(indices_3_0_buf, 0, 0, ((class ap_uint< 512 > *)indices),((0 + (start * 180000 + j0 * 18000)) * sizeof(int )),(sizeof(int ) * ((unsigned long )18000)));
      for (i = 0; i < 18; ++i) {
...
#pragma ACCEL PIPELINE II=1
          ...
          idx_step < 90000?((void )0) : __assert_fail("idx_step < 90000","normal_kernel.cpp",327,__PRETTY_FUNCTION__);
          idx_step1 < 90000?((void )0) : __assert_fail("idx_step1 < 90000","normal_kernel.cpp",328,__PRETTY_FUNCTION__);
...
#pragma ACCEL PARALLEL COMPLETE
          accu_local[i] = accu[i][sub_start] / 18;
        }
