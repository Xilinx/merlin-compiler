...
{   
    ...
    int i=0;
    long inc = 1;
    long * a = (long *)alignedMalloc(sizeof(long)*VEC_SIZE*TILE); 
    long * b = (long *)alignedMalloc(sizeof(long)*VEC_SIZE*TILE); 
    long * c = (long *)alignedMalloc(sizeof(long)*VEC_SIZE*TILE); 
