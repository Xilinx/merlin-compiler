...
{   
    ...
    int i=0;
    double inc = 1;
    double * a = (double *)alignedMalloc(sizeof(double)*VEC_SIZE*TILE); 
    double * b = (double *)alignedMalloc(sizeof(double)*VEC_SIZE*TILE); 
    double * c = (double *)alignedMalloc(sizeof(double)*VEC_SIZE*TILE); 
