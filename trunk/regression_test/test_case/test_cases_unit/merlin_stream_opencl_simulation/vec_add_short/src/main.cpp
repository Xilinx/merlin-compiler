...
{   
    ...
    int i=0;
    short inc = 1;
    short * a = (short *)alignedMalloc(sizeof(short)*VEC_SIZE*TILE); 
    short * b = (short *)alignedMalloc(sizeof(short)*VEC_SIZE*TILE); 
    short * c = (short *)alignedMalloc(sizeof(short)*VEC_SIZE*TILE); 
