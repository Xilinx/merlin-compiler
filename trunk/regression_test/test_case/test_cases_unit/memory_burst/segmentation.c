...
void initial(float phi[(64 + 2) * 66 * 66  + (64 + 2) * 66 + 64 + 2])
{
  int i;
  int j;
  int k;
...
void finalloop(float phi[(64 + 2) * 66 * 66  + (64 + 2) * 66 + 64 + 2],float curvature_motion_part_g[(64 + 2) * 66 * 66  + (64 + 2) * 66 + 64 + 2],float dt)
{
  int i;
  int j;
  int k;
...
#pragma ACCEL kernel
void kernel_segmentation(float interpt[(64 + 2) * 66 * 66  + (64 + 2) * 66 + 64 + 2],float curvature_motion_part_g[(64 + 2) * 66 * 66  + (64 + 2) * 66 + 64 + 2])
{
  float lambda1 = 1;
  float lambda2 = 1;
  ...
  float Dxz;
  float Dyz;
  float phi[(64 + 2) * 66 * 66  + (64 + 2) * 66 + 64 + 2];
  initial(phi);
...
//#pragma HLS array_partition variable=phi cyclic factor=3 dim=3
              ...
              curvature_motion_part_g[(i) * 66 * 66  + (j) * 66 + k] = Grad * (mu * K + lambda1 * (interpt[(i) * 66 * 66  + (j) * 66 + k] - c1) * (interpt[(i) * 66 * 66  + (j) * 66 + k] - c1) - lambda2 * (interpt[(i) * 66 * 66  + (j) * 66 + k] - c2) * (interpt[(i) * 66 * 66  + (j) * 66 + k] - c2));
            }
          }
        }
      }
...
int main()
{
  float interpt[(64 + 2) * 66 * 66  + (64 + 2) * 66 + 64 + 2];
  float curvature_motion_part_g[(64 + 2) * 66 * 66  + (64 + 2) * 66 + 64 + 2];
