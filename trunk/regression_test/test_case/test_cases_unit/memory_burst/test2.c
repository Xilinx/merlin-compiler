...
#pragma ACCEL pipeline_parallel factor = 4
      a[i *  10 + j] = b[i *  10 + j] + b[(i + 1) *  10 + j] + b[(i - 1) *  10 + j];
    }
  }
}
...
#pragma ACCEL pipeline
      a[i *  10 + j] = b[2 * i *  10 + j] + b[(2 * i + 1) *  10 + j] + b[(2 * i - 1) *  10 + j];
    }
  }
}
...
#pragma ACCEL pipeline_parallel factor = 10
      a[i *  10 + j] = b[16 * i *  10 + j] + b[(16 * i + 1) *  10 + j] + b[(16 * i - 1) *  10 + j];
    }
  }
}
...
#pragma ACCEL pipeline
      a[i *  10 + j] = b[10587946 * i *  10 + j] + b[(10587946 * i + 1) *  10 + j] + b[(10587946 * i - 1) *  10 + j];
    }
  }
}
...
#pragma ACCEL pipeline_parallel factor = 10
      a[i *  10 + j] = b[10587946 * i *  10 + j] + b[(35935221 * i + 1) *  10 + j] + b[(43453045 * i - 1) *  10 + j];
    }
  }
}
...
#pragma ACCEL pipeline_parallel factor = 10
      a[i *  10 + j] = b[1024 * i + j] + b[1024 + j] + b[1024 * i - 1024 + j];
    }
  }
}
...
#pragma ACCEL pipeline_parallel factor = 10
      a[i *  10 + j] = b[3 * i *  10 + j] + b[2 * i *  10 + j] + b[(1 * i - 1) *  10 + j];
    }
  }
}
...
#pragma ACCEL pipeline_parallel factor=4 priority=logic
      a[i *  10 + j] = b[(i - 1) *  10 + j] + b[(i + 1) *  10 + j] + b[i *  10 + j];
    }
  }
}
...
#pragma ACCEL pipeline_parallel factor = 10
      a[i *  10 + j] = b[3 * i *  10 + i + j] + b[2 * i *  10 + i + j] + b[(1 * i - 1) *  10 + i + j + 1];
    }
  }
}
#define _PB_N 5
