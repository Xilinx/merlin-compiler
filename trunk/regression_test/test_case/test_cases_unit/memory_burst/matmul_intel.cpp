...
{
  float *a;
  //cmost_malloc(((void **)(&a)),4 * (VEC_SIZE * VEC_SIZE));
  float *b;
  //cmost_malloc(((void **)(&b)),4 * (VEC_SIZE * VEC_SIZE));
  float *c;
  //cmost_malloc(((void **)(&c)),4 * (VEC_SIZE * VEC_SIZE));
...
//cmost_load_file(c, "0"           , VEC_flat_SIZE * 4);
  ...
  matmul_kernel(a,b,c);
  //cmost_write_file(c,"c_out.dat",VEC_SIZE * VEC_SIZE * 4);
