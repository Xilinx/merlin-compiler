...
#pragma AP loop_tripcount max=256
      tmp1_0[i][j] = img_0[ip * 32 * 256 + i * 256 + j];
      tmp1_1[i][j] = img_1[ip * 32 * 256 + i * 256 + j];
      tmp1_2[i][j] = img_2[ip * 32 * 256 + i * 256 + j];
      tmp1_3[i][j] = img_3[ip * 32 * 256 + i * 256 + j];
      tmp1_4[i][j] = img_4[ip * 32 * 256 + i * 256 + j];
      tmp1_5[i][j] = img_5[ip * 32 * 256 + i * 256 + j];
      tmp1_6[i][j] = img_6[ip * 32 * 256 + i * 256 + j];
      tmp1_7[i][j] = img_7[ip * 32 * 256 + i * 256 + j];
    }
  }
  for (i = 0; i < n / 8; i++) {
...
// tmp1(2*((8*i+0)-128)+1, j); //tmp1_0[i][j];
      img_0[ip * 32 * 256 + i * 256 + j] = (8 * i < 128?tmp1_0[2 * i][j] : tmp1_1[2 * i - 32][j]);
// tmp1(2*((8*i+1)-128)+1, j); //tmp1_0[i][j];
      img_1[ip * 32 * 256 + i * 256 + j] = (8 * i < 128?tmp1_2[2 * i][j] : tmp1_3[2 * i - 32][j]);
// tmp1(2*((8*i+2)-128)+1, j); //tmp1_0[i][j];
      img_2[ip * 32 * 256 + i * 256 + j] = (8 * i < 128?tmp1_4[2 * i][j] : tmp1_5[2 * i - 32][j]);
// tmp1(2*((8*i+3)-128)+1, j); //tmp1_0[i][j];
      img_3[ip * 32 * 256 + i * 256 + j] = (8 * i < 128?tmp1_6[2 * i][j] : tmp1_7[2 * i - 32][j]);
// tmp1(2*((8*i+4)-128)+1, j); //tmp1_0[i][j];
      img_4[ip * 32 * 256 + i * 256 + j] = (8 * i < 128?tmp1_0[2 * i + 1][j] : tmp1_1[2 * i - 32 + 1][j]);
// tmp1(2*((8*i+5)-128)+1, j); //tmp1_0[i][j];
      img_5[ip * 32 * 256 + i * 256 + j] = (8 * i < 128?tmp1_2[2 * i + 1][j] : tmp1_3[2 * i - 32 + 1][j]);
// tmp1(2*((8*i+6)-128)+1, j); //tmp1_0[i][j];
      img_6[ip * 32 * 256 + i * 256 + j] = (8 * i < 128?tmp1_4[2 * i + 1][j] : tmp1_5[2 * i - 32 + 1][j]);
// tmp1(2*((8*i+7)-128)+1, j); //tmp1_0[i][j];
      img_7[ip * 32 * 256 + i * 256 + j] = (8 * i < 128?tmp1_6[2 * i + 1][j] : tmp1_7[2 * i - 32 + 1][j]);
    }
  }
}
...
#pragma ACCEL graph_begin
  int ip;
  for (ip = 0; ip < 16; ip++) {
    
#pragma ACCEL task_begin name="dwt3d"
    fwt97_pd_foo_one_pic(img_0,img_1,img_2,img_3,img_4,img_5,img_6,img_7,ip,m,n,m,n);
    
#pragma ACCEL task_end
  }
  
#pragma ACCEL graph_end
}
