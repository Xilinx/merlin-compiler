...
void top(int *a_p1_x,int *a_p1_y,int *a_p2_x,int *a_p2_y)
{
...
#pragma ACCEL wrapper VARIABLE=a->p1->y port=a_p1_y data_type=int
  
#pragma ACCEL wrapper VARIABLE=a->p2->x port=a_p2_x data_type=int
  
#pragma ACCEL wrapper VARIABLE=a->p2->y port=a_p2_y data_type=int
