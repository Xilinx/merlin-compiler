...
#pragma ACCEL stream_channel channel_depth=200 node=msm_node_0 port=msm_port_c_buf_0_msm_node_0_0
merlin_stream ch_c_buf_0_2_p[5][10];
#pragma ACCEL stream_channel channel_depth=200 node=msm_node_0 port=msm_port_a_buf_0_msm_node_0_0
merlin_stream ch_a_buf_0_1_p[5][10];
#pragma ACCEL stream_channel channel_depth=200 node=msm_node_0 port=msm_port_b_buf_0_msm_node_0_0
...
void func(int b_buf_0[5][20][10][10],int a_buf_0[5][20][10][10],int c_buf_0[5][20][10][10],int jj) {
  int k0;
  int kk;
  for (k0 = 0; k0 < 10; ++k0) {
...
// Original: #pragma ACCEL PARALLEL COMPLETE
{
        ...
        merlin_stream_read(&ch_b_buf_0_0_p[jj][kk],(&b_buf_0_sn_tmp_0));
        merlin_stream_read(&ch_a_buf_0_1_p[jj][kk],(&a_buf_0_sn_tmp_0));
        c_buf_0_sn_tmp_0 = a_buf_0_sn_tmp_0 + b_buf_0_sn_tmp_0;
        merlin_stream_write(&ch_c_buf_0_2_p[jj][kk],(&c_buf_0_sn_tmp_0));
      }
}
}

void msm_node_0(int b_buf_0[5][20][10][10],int a_buf_0[5][20][10][10],int c_buf_0[5][20][10][10],int jj)
// Original: #pragma ACCEL parallel
// Original: #pragma ACCEL PARALLEL COMPLETE
{
  int j0;
  for (j0 = 0; j0 < 20; ++j0) {
    func(b_buf_0, a_buf_0, c_buf_0, jj);
  }
}
...
// Original: #pragma ACCEL PARALLEL COMPLETE
{
        ...
        b_buf_0_sp_tmp_0 = b_buf_0[_jj][_j0][_k0][_kk];
        merlin_stream_write(&ch_b_buf_0_0_p[jj][_kk],(&b_buf_0_sp_tmp_0));
      }
    }
  }
}
...
// Original: #pragma ACCEL PARALLEL COMPLETE
{
        ...
        a_buf_0_sp_tmp_0 = a_buf_0[_jj][_j0][_k0][_kk];
        merlin_stream_write(&ch_a_buf_0_1_p[jj][_kk],(&a_buf_0_sp_tmp_0));
      }
    }
  }
}
...
// Original: #pragma ACCEL PARALLEL COMPLETE
{
        ...
        merlin_stream_read(&ch_c_buf_0_2_p[jj][_kk],(&c_buf_0_sp_tmp_0));
        c_buf_0[_jj][_j0][_k0][_kk] = c_buf_0_sp_tmp_0;
      }
    }
  }
}
...
// Original pragma: ACCEL stream_port access_type=read dim_num=4 node=msm_node_0 variable=b_buf_0
      
#pragma ACCEL stream_port access_type=read dim_num=4 node=msm_node_0 parallel_iterator=1 variable=b_buf_0
      msm_port_b_buf_0_msm_node_0_0(b_buf_0,jj);
      int kk_1;
...
// Original pragma: ACCEL stream_port access_type=read dim_num=4 node=msm_node_0 variable=a_buf_0
      
#pragma ACCEL stream_port access_type=read dim_num=4 node=msm_node_0 parallel_iterator=1 variable=a_buf_0
      msm_port_a_buf_0_msm_node_0_0(a_buf_0,jj);
// Original: #pragma ACCEL parallel
// Original: #pragma ACCEL PARALLEL COMPLETE
      int kk;
...
#pragma ACCEL stream_node parallel_factor=5 parallel_iterator=3
      msm_node_0(b_buf_0,a_buf_0,c_buf_0,jj);
// Original pragma: ACCEL stream_port access_type=write dim_num=4 node=msm_node_0 variable=c_buf_0
      
#pragma ACCEL stream_port access_type=write dim_num=4 node=msm_node_0 parallel_iterator=1 variable=c_buf_0
      msm_port_c_buf_0_msm_node_0_0(c_buf_0,jj);
      int kk_0;
