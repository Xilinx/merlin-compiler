...
#pragma ACCEL interface variable=merlin_out depth=1024,1020 max_depth=1024,1020 BURST_OFF
  
#pragma ACCEL interface variable=filter depth=5 max_depth=5
  
#pragma ACCEL interface variable=merlin_in depth=1025,1025 max_depth=1025,1025 BURST_OFF streaming_access=0,1050625
  ...
  for (int i = 0; i < 1024; i++) {
    ...
    __merlin_streaming_range(merlin_in,(0L + i * 1L) * 1025L,1024L);
...
#pragma ACCEL PARALLEL COMPLETE 
        ...
        tmp_wind_0 = merlin_in[(0L + i * 1L) * 1025L + (j + 4L + 0L) * 1L];
