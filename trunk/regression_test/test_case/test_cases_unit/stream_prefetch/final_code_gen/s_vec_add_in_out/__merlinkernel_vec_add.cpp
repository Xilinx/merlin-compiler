...
// Original: #pragma ACCEL array_partition type=channel variable=ch_c_1 dim=1 factor=4
...
{
      int c_sp_tmp_0;
      merlin_stream_read(&ch_c_1_p[_i_sub],(&c_sp_tmp_0));
...
// Original: #pragma ACCEL PARALLEL FACTOR=4
{
  ...
  c_sn_tmp_0 = c0;
  merlin_stream_write(&ch_c_1_p[i_sub],(void *)(&c_sn_tmp_0));
}
...
#pragma unroll
  for (_i_sub = 0; _i_sub <= 3; ++_i_sub) {
    merlin_stream_init(&ch_c_1_p[_i_sub],(unsigned long )1024,(unsigned long )4);
  }
  int _i_sub_1;
  
#pragma unroll
  for (_i_sub_1 = 0; _i_sub_1 <= 3; ++_i_sub_1) {
    merlin_stream_init(&ch_a_0_p[_i_sub_1],(unsigned long )1024,(unsigned long )4);
  }
...
#pragma unroll
  for (_i_sub_2 = 0; _i_sub_2 <= 3; ++_i_sub_2) {
    merlin_stream_reset(&ch_a_0_p[_i_sub_2]);
  }
...
#pragma unroll
  for (_i_sub_0 = 0; _i_sub_0 <= 3; ++_i_sub_0) {
    merlin_stream_reset(&ch_c_1_p[_i_sub_0]);
  }
}
