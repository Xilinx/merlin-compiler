...
opencl_kernel __msm_port_b_vec_add_0_kernel;
cl_event __event_msm_port_b_vec_add_0;
...
int __merlin_init_vec_add(){
	...
	#pragma ACCEL debug printf("[Merlin Info] Successful create kernel for %s....\n", "msm_port_a_vec_add_0");
	#pragma ACCEL debug fflush(stdout);
	#pragma ACCEL debug printf("[Merlin Info] Start create kernel for %s....\n", "msm_port_b_vec_add_0");
	#pragma ACCEL debug fflush(stdout);
	opencl_create_kernel(&__msm_port_b_vec_add_0_kernel, (char *)"msm_port_b_vec_add_0");
	#pragma ACCEL debug printf("[Merlin Info] Successful create kernel for %s....\n", "msm_port_b_vec_add_0");
	#pragma ACCEL debug fflush(stdout);
...
int __merlin_wait_kernel_vec_add(){
	...
	opencl_wait_event(__event_msm_port_b_vec_add_0);
