...
#pragma ACCEL interface variable=b max_depth=1024 depth=1024 stream_prefetch=on
  
#pragma ACCEL interface variable=c max_depth=1024 depth=1024 stream_prefetch=on
