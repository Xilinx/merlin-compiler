...
#pragma ACCEL interface variable=a stream_prefetch=on max_depth=1024 depth=1024 stream_prefetch=off
  
#pragma ACCEL interface variable=b stream_prefetch=off max_depth=1024 depth=1024 stream_prefetch=on
  
#pragma ACCEL interface variable=c stream_prefetch=on max_depth=1024 depth=1024 stream_prefetch=on
