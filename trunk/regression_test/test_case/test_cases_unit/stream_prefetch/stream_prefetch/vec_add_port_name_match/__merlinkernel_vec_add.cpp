...
#pragma ACCEL PARALLEL 
      ...
      for (int j = 0; j < 1024 * 10; j++) {
        c0 += ((int )(pow((double )(a0 * b0 + j),1.5))) % 7 + merlin_s;
      }
      c[i * 4 + i_sub + merlin_s] = c0;
    }
  }
}
