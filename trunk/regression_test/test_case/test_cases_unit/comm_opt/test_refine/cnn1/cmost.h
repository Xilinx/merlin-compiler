...
int cmost_malloc_1d(void ** a, char * filename, int unit_size, size_t d0 );
...
int altera_malloc(void ** a, char * filename, int unit_size, size_t d0 );
...
void cmost_write_file(void * buffer, char * file_name, size_t size);
void cmost_load_file(void * buffer, char * file_name, size_t size);
