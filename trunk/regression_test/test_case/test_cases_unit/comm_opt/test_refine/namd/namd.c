...
void namd_kernel(int cell_to_run,int neighbour_to_run,int cell_size,float *i_cell_pos,float *i_cell_vel,float *o_cell_pos,float *o_cell_vel);
...
// 32'h0600 0000
  float *i_cell_pos;
  cmost_malloc_1d((&i_cell_pos),"i_cell_pos.dat",4,1400000);
// 32'h0680 0000
  float *i_cell_vel;
  cmost_malloc_1d((&i_cell_vel),"i_cell_vel.dat",4,1400000);
// 32'h0700 0000
  float *o_cell_pos;
  cmost_malloc_1d((&o_cell_pos),"0",4,1400000);
// 32'h0780 0000
  float *o_cell_vel;
  cmost_malloc_1d((&o_cell_vel),"0",4,1400000);
// 32'h
  float *i_cell_pos_fake;
  cmost_malloc_1d((&i_cell_pos_fake),"0",4,1400000);
