...
//result1[j][k] += global_weights[k*784+ i] * data[j][i];
        result1[j][k] += global_weights[i * 16 + k] * data[j][i];
      }
    }
  }
}
...
#pragma ACCEL PARALLEL COMPLETE
      ...
      temp_0 = 1 + result1[j][k] * result1[j][k];
      result2[j][k] = result1[j][k] / (((float )1) + result1[j][k] * result1[j][k]) - (2.f * data2[j][k] - 1.f) / sqrtf(((float )1) + result1[j][k] * result1[j][k]);
    }
  }
}
...
void logistic_regression_kernel(int n_samples,float *global_weights,float *global_weights_2,float *global_data,float *global_data2,float *global_gradient,float *global_gradient_2)
{
  ...
  float global_weights_buf_0_0[784][16];
...
//pipeline( n_samples, global_data, global_data2, global_weights, global_gradient);
  for (i = 0; i < n_samples / 32; i++) {
    for (_memcpy_i0_1 = 0; _memcpy_i0_1 < 784; ++_memcpy_i0_1) {
    ...
    for (_memcpy_i2_1 = 0; _memcpy_i2_1 < 32; ++_memcpy_i2_1) {
      for (_memcpy_i2_0 = 0; _memcpy_i2_0 < 784; ++_memcpy_i2_0) {
        data_0_tmp = global_data[i * 32 * 784 + ((0 * 32 + _memcpy_i2_1) * 784 + _memcpy_i2_0)];
    ...
    for (_memcpy_i3_1 = 0; _memcpy_i3_1 < 32; ++_memcpy_i3_1) {
      for (_memcpy_i3_0 = 0; _memcpy_i3_0 < 16; ++_memcpy_i3_0) {
        data2_0[_memcpy_i3_1][_memcpy_i3_0] = global_data2[i * 32 * 16 + ((0 * 32 + _memcpy_i3_1) * 16 + _memcpy_i3_0)];
      }
    }
{
...
#pragma ACCEL PARALLEL COMPLETE
          result1_0[j__compute1_0][k__compute1_0] = global_weights_2_buf_0_0[k__compute1_0];
        }
      }
...
//result1[j][k] += weights[i+1][k] * data[j][i];
//result1[j][k] += global_weights[k*784+ i] * data[j][i];
            result1_0[j__compute1_0][k__compute1_0] += global_weights_buf_0_0[i__compute1_0][k__compute1_0] * data_0[j__compute1_0][i__compute1_0];
            result1_0_rn[j__compute1_0][k__compute1_0] = result1_0[j__compute1_0][k__compute1_0];
          }
        }
      }
    }
...
#pragma ACCEL PARALLEL COMPLETE
          ...
          temp_0__compute2_0 = ((float )1) + result1_0_rn[j__compute2_0][k__compute2_0] * result1_0_rn[j__compute2_0][k__compute2_0];
          result2_0_tmp = result1_0_rn[j__compute2_0][k__compute2_0] / (((float )1) + result1_0_rn[j__compute2_0][k__compute2_0] * result1_0_rn[j__compute2_0][k__compute2_0]) - (2.f * data2_0[j__compute2_0][k__compute2_0] - 1.f) / sqrtf(((float )1) + result1_0_rn[j__compute2_0][k__compute2_0] * result1_0_rn[j__compute2_0][k__compute2_0]);
    ...
    }
{
      for (j__compute3_0 = 0; j__compute3_0 < 32; j__compute3_0++) {
        for (i__compute3_0 = 0; i__compute3_0 < 784; i__compute3_0++) {
          tmp_0__compute3_0 = data_0_rn[j__compute3_0][i__compute3_0];
          for (k__compute3_0 = 0; k__compute3_0 < 16; k__compute3_0++) 
/* Original: #pragma ACCEL parallel */
{
            
#pragma ACCEL PARALLEL COMPLETE
            gradient[k__compute3_0][i__compute3_0] += result2_0[j__compute3_0][k__compute3_0] * data_0_rn[j__compute3_0][i__compute3_0];
            gradient_rn[k__compute3_0][i__compute3_0] = gradient[k__compute3_0][i__compute3_0];
          }
        }
      }
      for (j__compute3_0 = 0; j__compute3_0 < 32; j__compute3_0++) {
...
#pragma ACCEL PARALLEL COMPLETE
          gradient_2[k__compute3_0] += result2_0_rn[j__compute3_0][k__compute3_0];
          gradient_2_rn[k__compute3_0] = gradient_2[k__compute3_0];
        }
      }
    }
  }
...
#pragma ACCEL PARALLEL COMPLETE
  ...
  for (_memcpy_i4_1 = 0; _memcpy_i4_1 < 784; ++_memcpy_i4_1) {
    for (_memcpy_i4_0 = 0; _memcpy_i4_0 < 16; ++_memcpy_i4_0) {
      global_gradient[0 + ((0 * 784 + _memcpy_i4_1) * 16 + _memcpy_i4_0)] = global_gradient_buf_0[_memcpy_i4_1][_memcpy_i4_0];
    }
  }
}
