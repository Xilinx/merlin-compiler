...
//float * global_gradient_gold; cmost_malloc_1d( &global_gradient_gold, "gradient_gold.dat"  , 4, WEIGHTS_SIZE);
  ...
  logistic_regression_kernel(n_samples,global_weights,global_data,global_data2,global_gradient_org);
  int i;
  int err = 0;
