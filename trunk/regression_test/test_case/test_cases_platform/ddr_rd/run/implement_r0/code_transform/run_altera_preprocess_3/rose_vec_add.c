...
void __merlinoldkernel_test_kernel(int burst_length,int burst_number,int *a,int out);
...
#pragma ACCEL string opencl_init_test_kernel("kernel_top.aocx");
  __merlinwrapper_test_kernel(burst_length,burst_number,a,out);
  return 0;
}
