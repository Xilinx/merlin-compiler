...
{
//    if (a != 0) {
//      opencl_write_buffer(__test_kernel__a_buffer,commands[0],0 * sizeof(int ),((int *)a),((unsigned long )burst_length) * sizeof(int ));
//    }
//     else {
...
#pragma tldm task_block name="unmaned_task1"
{
    ...
    opencl_set_kernel_arg(__test_kernel_kernel, 3, sizeof(int), &out);
