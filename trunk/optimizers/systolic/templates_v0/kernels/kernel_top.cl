...
constant unsigned int cfg_in_num[] = {16, 64};
constant unsigned int cfg_out_num[] = {64, 64};
constant unsigned int cfg_img_row[] = {224, 224};
constant unsigned int cfg_img_col[] = {224, 224};
constant unsigned int cfg_kernel[] = {3, 3};

constant unsigned int cfg_BN_R[] = {12, 12};
constant unsigned int cfg_BN_C[] = {16, 16};
constant unsigned int cfg_BN_O[] = {2, 2};
constant unsigned int cfg_BN_I[] = {1, 2};
constant unsigned int cfg_BN_P[] = {1, 1};
constant unsigned int cfg_BN_Q[] = {1, 1};
