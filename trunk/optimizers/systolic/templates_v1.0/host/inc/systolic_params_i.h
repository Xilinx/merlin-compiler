...
//;    $bn_i *= $v_block_dim_h[$i];
//; }
//;
//; $bn_k = $v_block_dim_h[@v_block_dim_h - 1];
//;
//; my $bn_j = 1;
...
//; my $bs_i = 1;
//; for (my $i = 0; $i < @v_buffer_dim_h - 1; $i++) {
//;    $bs_i *= $v_buffer_dim_h[$i];
//; }
//;
//; my $bs_k = $v_buffer_dim_h[@v_buffer_dim_h - 1];
//;
...
//; for (my $i = 1; $i < @v_feeder_iteration_domain; $i++){
...
//; for (my $i = 0; $i < @v_block_size_h - 1; $i++){
//;    $h_block_height *= $v_block_size_h[$i];
//; }
//;
//; my $h_block_width = $v_block_size_h[@v_block_size_h - 1];
...
#define DEBUG_PE_I 0
#define DEBUG_PE_J 0
#define DEBUG_PE_IDX 1
#define CPU_PE_DEBUG_I 0
#define CPU_PE_DEBUG_J 0
#define CPU_PE_DEBUG_IDX 1
//; }
