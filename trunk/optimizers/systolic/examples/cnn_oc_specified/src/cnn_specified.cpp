...
#define R1 (IMG_ROW + KERNEL - 1)  // input dim with padding
#define C1 (IMG_COL + KERNEL - 1)


#pragma ACCEL kernel 
void cnn_kernel(int in[R1][C1][IMG_IN_NUM], int weight[IMG_OUT_NUM][K][K][IMG_IN_NUM], int out[IMG_OUT_NUM][IMG_ROW][IMG_COL])
{
