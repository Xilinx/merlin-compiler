...
#ifndef HLS_MATH_H_INCLUDED
#define HLS_MATH_H_INCLUDED
...
#if 0  // ZP: These funcitons will report an error when working together with <math.h>
  // signbit
//  int signbit(double);
//  int signbit(float);
//  int signbit(half);
